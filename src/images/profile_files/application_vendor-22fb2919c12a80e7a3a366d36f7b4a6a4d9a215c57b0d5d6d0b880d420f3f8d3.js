"function" != typeof Function.prototype.bind && (Function.prototype.bind = function(e) {
  ...
  function n(e, t, i) {
    ...
    if ("string" == typeof t) {
      if (Ce.test(t)) return fe.filter(t, e, i);
      t = fe.filter(t, e);
    }
  ...
  function o() {
    ne.addEventListener ? (ne.removeEventListener("DOMContentLoaded", a), e.removeEventListener("load", a)) :(ne.detachEvent("onreadystatechange", a), 
    e.detachEvent("onload", a));
  }
  function a() {
    (ne.addEventListener || "load" === e.event.type || "complete" === ne.readyState) && (o(), 
    fe.ready());
  }
  function l(e, t, i) {
    if (i === undefined && 1 === e.nodeType) {
      var n = "data-" + t.replace(Fe, "-$1").toLowerCase();
      if ("string" == typeof (i = e.getAttribute(n))) {
        try {
          i = "true" === i || "false" !== i && ("null" === i ? null :+i + "" === i ? +i :Pe.test(i) ? fe.parseJSON(i) :i);
        } catch (e) {}
        fe.data(e, t, i);
      } else i = undefined;
    }
  ...
  function u(e, t, i, n) {
    if (De(e)) {
      var s, r, o = fe.expando, a = e.nodeType, l = a ? fe.cache :e, c = a ? e[o] :e[o] && o;
      if (c && l[c] && (n || l[c].data) || i !== undefined || "string" != typeof t) return c || (c = a ? e[o] = ie.pop() || fe.guid++ :o), 
      l[c] || (l[c] = a ? {} :{
        toJSON:fe.noop
      }), "object" != typeof t && "function" != typeof t || (n ? l[c] = fe.extend(l[c], t) :l[c].data = fe.extend(l[c].data, t)), 
      r = l[c], n || (r.data || (r.data = {}), r = r.data), i !== undefined && (r[fe.camelCase(t)] = i), 
      "string" == typeof t ? null == (s = r[t]) && (s = r[fe.camelCase(t)]) :s = r, s;
    }
  }
  function h(e, t, i) {
    if (De(e)) {
      var n, s, r = e.nodeType, o = r ? fe.cache :e, a = r ? e[fe.expando] :fe.expando;
      if (o[a]) {
        ...
        (i || (delete o[a].data, c(o[a]))) && (r ? fe.cleanData([ e ], !0) :he.deleteExpando || o != o.window ? delete o[a] :o[a] = undefined);
      }
    }
  }
  function d(e, t, i, n) {
    var s, r = 1, o = 20, a = n ? function() {
      ...
      return fe.css(e, t, "");
    }, l = a(), c = i && i[3] || (fe.cssNumber[t] ? "" :"px"), u = (fe.cssNumber[t] || "px" !== c && +l) && Ie.exec(fe.css(e, t));
    if (u && u[3] !== c) {
      c = c || u[3], i = i || [], u = +l || 1;
      do {
    ...
    return i && (u = +u || +l || 0, s = i[1] ? u + (i[1] + 1) * i[2] :+i[2], n && (n.unit = c, 
    n.start = u, n.end = s)), s;
  }
  function f(e) {
    var t = Be.split("|"), i = e.createDocumentFragment();
    if (i.createElement) for (;t.length; ) i.createElement(t.pop());
    return i;
  }
  function p(e, t) {
    var i, n, s = 0, r = "undefined" != typeof e.getElementsByTagName ? e.getElementsByTagName(t || "*") :"undefined" != typeof e.querySelectorAll ? e.querySelectorAll(t || "*") :undefined;
    if (!r) for (r = [], i = e.childNodes || e; null != (n = i[s]); s++) !t || fe.nodeName(n, t) ? r.push(n) :fe.merge(r, p(n, t));
  ...
  function v(e, t, i, n, s) {
    for (var r, o, a, l, c, u, h, d = e.length, v = f(t), y = [], b = 0; b < d; b++) if ((o = e[b]) || 0 === o) if ("object" === fe.type(o)) fe.merge(y, o.nodeType ? [ o ] :o); else if (Ve.test(o)) {
      for (l = l || v.appendChild(t.createElement("div")), c = (Re.exec(o) || [ "", "" ])[1].toLowerCase(), 
      h = qe[c] || qe._default, l.innerHTML = h[1] + fe.htmlPrefilter(o) + h[2], r = h[0]; r--; ) l = l.lastChild;
      if (!he.leadingWhitespace && $e.test(o) && y.push(t.createTextNode($e.exec(o)[0])), 
      !he.tbody) for (o = "table" !== c || Ue.test(o) ? "<table>" !== h[1] || Ue.test(o) ? 0 :l :l.firstChild, 
      r = o && o.childNodes.length; r--; ) fe.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
      for (fe.merge(y, l.childNodes), l.textContent = ""; l.firstChild; ) l.removeChild(l.firstChild);
      l = v.lastChild;
    } else y.push(t.createTextNode(o));
    for (l && v.removeChild(l), he.appendChecked || fe.grep(p(y, "input"), g), b = 0; o = y[b++]; ) if (n && fe.inArray(o, n) > -1) s && s.push(o); else if (a = fe.contains(o.ownerDocument, o), 
    l = p(v.appendChild(o), "script"), a && m(l), i) for (r = 0; o = l[r++]; ) We.test(o.type || "") && i.push(o);
    return l = null, v;
  }
  function y() {
    return !0;
  ...
  function x(e, t, i, n, s, r) {
    ...
    if (null == n && null == s ? (s = i, n = i = undefined) :null == s && ("string" == typeof i ? (s = n, 
    n = undefined) :(s = n, n = i, i = undefined)), !1 === s) s = b; else if (!s) return e;
    return 1 === r && (o = s, s = function(e) {
      return fe().off(e), o.apply(this, arguments);
    }, s.guid = o.guid || (o.guid = fe.guid++)), e.each(function() {
  ...
  function T(e, t) {
    if (1 === t.nodeType && fe.hasData(e)) {
      var i, n, s, r = fe._data(e), o = fe._data(t, r), a = r.events;
      if (a) {
        delete o.handle, o.events = {};
        for (i in a) for (n = 0, s = a[i].length; n < s; n++) fe.event.add(t, i, a[i][n]);
      }
  ...
  function k(e, t) {
    ...
    if (1 === t.nodeType) {
      if (i = t.nodeName.toLowerCase(), !he.noCloneEvent && t[fe.expando]) {
        s = fe._data(t);
        for (n in s.events) fe.removeEvent(t, n, s.handle);
        t.removeAttribute(fe.expando);
      }
      "script" === i && t.text !== e.text ? (C(t).text = e.text, S(t)) :"object" === i ? (t.parentNode && (t.outerHTML = e.outerHTML), 
      he.html5Clone && e.innerHTML && !fe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) :"input" === i && He.test(e.type) ? (t.defaultChecked = t.checked = e.checked, 
  ...
  function M(e, t, i, n) {
    t = re.apply([], t);
    var s, r, o, a, l, c, u = 0, h = e.length, d = h - 1, f = t[0], m = fe.isFunction(f);
    if (m || h > 1 && "string" == typeof f && !he.checkClone && it.test(f)) return e.each(function(s) {
      var r = e.eq(s);
      m && (t[0] = f.call(this, s, r.html())), M(r, t, i, n);
    });
    if (h && (c = v(t, e[0].ownerDocument, !1, e, n), s = c.firstChild, 1 === c.childNodes.length && (c = s), 
    s || n)) {
      for (a = fe.map(p(c, "script"), C), o = a.length; u < h; u++) r = c, u !== d && (r = fe.clone(r, !0, !0), 
      o && fe.merge(a, p(r, "script"))), i.call(e[u], r, u);
      if (o) for (l = a[a.length - 1].ownerDocument, fe.map(a, S), u = 0; u < o; u++) r = a[u], 
      We.test(r.type || "") && !fe._data(r, "globalEval") && fe.contains(l, r) && (r.src ? fe._evalUrl && fe._evalUrl(r.src) :fe.globalEval((r.text || r.textContent || r.innerHTML || "").replace(st, "")));
      c = s = null;
    }
    return e;
  }
  function E(e, t, i) {
    for (var n, s = t ? fe.filter(t, e) :e, r = 0; null != (n = s[r]); r++) i || 1 !== n.nodeType || fe.cleanData(p(n)), 
    n.parentNode && (i && fe.contains(n.ownerDocument, n) && m(p(n, "script")), n.parentNode.removeChild(n));
    return e;
  }
  function j(e, t) {
  ...
  function A(e) {
    var t = ne, i = lt[e];
    return i || (i = j(e, t), "none" !== i && i || (at = (at || fe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), 
    t = (at[0].contentWindow || at[0].contentDocument).document, t.write(), t.close(), 
    i = j(e, t), at.detach()), lt[e] = i), i;
  }
  function D(e, t) {
    return {
      get:function() {
  ...
  function P(e) {
    if (e in Ct) return e;
    for (var t = e.charAt(0).toUpperCase() + e.slice(1), i = _t.length; i--; ) if ((e = _t[i] + t) in Ct) return e;
  }
  function F(e, t) {
    for (var i, n, s, r = [], o = 0, a = e.length; o < a; o++) n = e[o], n.style && (r[o] = fe._data(n, "olddisplay"), 
    i = n.style.display, t ? (r[o] || "none" !== i || (n.style.display = ""), "" === n.style.display && ze(n) && (r[o] = fe._data(n, "olddisplay", A(n.nodeName)))) :(s = ze(n), 
    (i && "none" !== i || !s) && fe._data(n, "olddisplay", s ? i :fe.css(n, "display"))));
  ...
  function I(e, t, i, n, s) {
    for (var r = i === (n ? "border" :"content") ? 4 :"width" === t ? 1 :0, o = 0; r < 4; r += 2) "margin" === i && (o += fe.css(e, i + Le[r], !0, s)), 
    n ? ("content" === i && (o -= fe.css(e, "padding" + Le[r], !0, s)), "margin" !== i && (o -= fe.css(e, "border" + Le[r] + "Width", !0, s))) :(o += fe.css(e, "padding" + Le[r], !0, s), 
    "padding" !== i && (o += fe.css(e, "border" + Le[r] + "Width", !0, s)));
    return o;
  }
  function L(t, i, n) {
    var s = !0, r = "width" === i ? t.offsetWidth :t.offsetHeight, o = ft(t), a = he.boxSizing && "border-box" === fe.css(t, "boxSizing", !1, o);
    if (ne.msFullscreenElement && e.top !== e && t.getClientRects().length && (r = Math.round(100 * t.getBoundingClientRect()[i])), 
    r <= 0 || null == r) {
      if (r = pt(t, i, o), (r < 0 || null == r) && (r = t.style[i]), ut.test(r)) return r;
      s = a && (he.boxSizingReliable() || r === t.style[i]), r = parseFloat(r) || 0;
    }
    return r + I(t, i, n || (a ? "border" :"content"), s, o) + "px";
  }
  ...
  function H(e, t) {
    ...
    for (t = t ? 1 :0; s < 4; s += 2 - t) i = Le[s], n["margin" + i] = n["padding" + i] = e;
    return t && (n.opacity = n.width = e), n;
  }
  function R(e, t, i) {
    for (var n, s = (B.tweeners[t] || []).concat(B.tweeners["*"]), r = 0, o = s.length; r < o; r++) if (n = s[r].call(i, t, e)) return n;
  }
  function W(e, t, i) {
    var n, s, r, o, a, l, c, u = this, h = {}, d = e.style, f = e.nodeType && ze(e), p = fe._data(e, "fxshow");
    i.queue || (a = fe._queueHooks(e, "fx"), null == a.unqueued && (a.unqueued = 0, 
    ...
    c = fe.css(e, "display"), "inline" === ("none" === c ? fe._data(e, "olddisplay") || A(e.nodeName) :c) && "none" === fe.css(e, "float") && (he.inlineBlockNeedsLayout && "inline" !== A(e.nodeName) ? d.zoom = 1 :d.display = "inline-block")), 
    i.overflow && (d.overflow = "hidden", he.shrinkWrapBlocks() || u.always(function() {
      d.overflow = i.overflow[0], d.overflowX = i.overflow[1], d.overflowY = i.overflow[2];
    }));
    for (n in t) if (s = t[n], kt.exec(s)) {
      if (delete t[n], r = r || "toggle" === s, s === (f ? "hide" :"show")) {
        if ("show" !== s || !p || p[n] === undefined) continue;
        f = !0;
      }
      h[n] = p && p[n] || fe.style(e, n);
    } else c = undefined;
    if (fe.isEmptyObject(h)) "inline" === ("none" === c ? A(e.nodeName) :c) && (d.display = c); else {
      p ? "hidden" in p && (f = p.hidden) :p = fe._data(e, "fxshow", {}), r && (p.hidden = !f), 
      ...
      for (n in h) o = R(f ? p[n] :0, n, u), n in p || (p[n] = o.start, f && (o.end = o.start, 
      o.start = "width" === n || "height" === n ? 1 :0));
    }
  }
  function $(e, t) {
    var i, n, s, r, o;
    for (i in e) if (n = fe.camelCase(i), s = t[n], r = e[i], fe.isArray(r) && (s = r[1], 
    r = e[i] = r[0]), i !== n && (e[n] = r, delete e[i]), (o = fe.cssHooks[n]) && "expand" in o) {
      r = o.expand(r), delete e[n];
      for (i in r) i in e || (e[i] = r[i], t[i] = s);
    } else t[n] = s;
  }
  function B(e, t, i) {
    var n, s, r = 0, o = B.prefilters.length, a = fe.Deferred().always(function() {
      delete l.elem;
    }), l = function() {
      if (s) return !1;
      for (var t = St || O(), i = Math.max(0, c.startTime + c.duration - t), n = i / c.duration || 0, r = 1 - n, o = 0, l = c.tweens.length; o < l; o++) c.tweens[o].run(r);
      return a.notifyWith(e, [ c, r, i ]), r < 1 && l ? i :(a.resolveWith(e, [ c ]), !1);
    }, c = a.promise({
      elem:e,
      props:fe.extend({}, t),
      opts:fe.extend(!0, {
    ...
    for ($(u, c.opts.specialEasing); r < o; r++) if (n = B.prefilters[r].call(c, e, u, c.opts)) return fe.isFunction(n.stop) && (fe._queueHooks(c.elem, c.opts.queue).stop = fe.proxy(n.stop, n)), 
    n;
    return fe.map(u, R, c), fe.isFunction(c.opts.start) && c.opts.start.call(e, c), 
  ...
  function V(e) {
    return function(t, i) {
      ...
      var n, s = 0, r = t.toLowerCase().match(Ee) || [];
      if (fe.isFunction(i)) for (;n = r[s++]; ) "+" === n.charAt(0) ? (n = n.slice(1) || "*", 
  ...
  function Y(e, t) {
    ...
    for (n in t) t[n] !== undefined && ((s[n] ? e :i || (i = {}))[n] = t[n]);
    return i && fe.extend(!0, e, i), e;
  }
  function X(e, t, i) {
    for (var n, s, r, o, a = e.contents, l = e.dataTypes; "*" === l[0]; ) l.shift(), 
    s === undefined && (s = e.mimeType || t.getResponseHeader("Content-Type"));
  ...
  function K(e, t, i, n) {
    ...
    if (fe.isArray(t)) fe.each(t, function(t, s) {
      i || ti.test(e) ? n(e, s) :K(e + "[" + ("object" == typeof s && null != s ? t :"") + "]", s, i, n);
    }); else if (i || "object" !== fe.type(t)) n(e, t); else for (s in t) K(e + "[" + s + "]", t[s], i, n);
  }
  function J() {
    try {
  ...
  var ie = [], ne = e.document, se = ie.slice, re = ie.concat, oe = ie.push, ae = ie.indexOf, le = {}, ce = le.toString, ue = le.hasOwnProperty, he = {}, de = "1.12.1", fe = function(e, t) {
    return new fe.fn.init(e, t);
  }, pe = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, me = /^-ms-/, ge = /-([\da-z])/gi, ve = function(e, t) {
  ...
  fe.fn = fe.prototype = {
    ...
    for ("boolean" == typeof o && (c = o, o = arguments[a] || {}, a++), "object" == typeof o || fe.isFunction(o) || (o = {}), 
    a === l && (o = this, a--); a < l; a++) if (null != (s = arguments[a])) for (n in s) e = o[n], 
    i = s[n], o !== i && (c && i && (fe.isPlainObject(i) || (t = fe.isArray(i))) ? (t ? (t = !1, 
    r = e && fe.isArray(e) ? e :[]) :r = e && fe.isPlainObject(e) ? e :{}, o[n] = fe.extend(c, r, i)) :i !== undefined && (o[n] = i));
    return o;
  }, fe.extend({
    ...
    isPlainObject:function(e) {
      ...
      if (!he.ownFirst) for (t in e) return ue.call(e, t);
      for (t in e) ;
    ...
    each:function(e, t) {
      var n, s = 0;
      if (i(e)) for (n = e.length; s < n && !1 !== t.call(e[s], s, e[s]); s++) ; else for (s in e) if (!1 === t.call(e[s], s, e[s])) break;
      return e;
    },
    trim:function(e) {
    ...
    merge:function(e, t) {
      ...
      if (i !== i) for (;t[n] !== undefined; ) e[s++] = t[n++];
      return e.length = s, e;
    },
    grep:function(e, t, i) {
    ...
    map:function(e, t, n) {
      var s, r, o = 0, a = [];
      if (i(e)) for (s = e.length; o < s; o++) null != (r = t(e[o], o, n)) && a.push(r); else for (o in e) null != (r = t(e[o], o, n)) && a.push(r);
      return re.apply([], a);
    },
    guid:1,
    proxy:function(e, t) {
      var i, n, s;
      return "string" == typeof t && (s = e[t], t = e, e = s), fe.isFunction(e) ? (i = se.call(arguments, 2), 
      n = function() {
  ...
  var ye = function(e) {
    function t(e, t, i, n) {
      var s, r, o, a, l, c, h, f, p = t && t.ownerDocument, m = t ? t.nodeType :9;
      if (i = i || [], "string" != typeof e || !e || 1 !== m && 9 !== m && 11 !== m) return i;
      if (!n && ((t ? t.ownerDocument || t :R) !== P && D(t), t = t || P, N)) {
        if (11 !== m && (c = ve.exec(e))) if (s = c[1]) {
          if (9 === m) {
            if (!(o = t.getElementById(s))) return i;
            if (o.id === s) return i.push(o), i;
          } else if (p && (o = p.getElementById(s)) && O(t, o) && o.id === s) return i.push(o), 
          i;
        } else {
          if (c[2]) return K.apply(i, t.getElementsByTagName(e)), i;
          if ((s = c[3]) && x.getElementsByClassName && t.getElementsByClassName) return K.apply(i, t.getElementsByClassName(s)), 
          i;
        }
        if (x.qsa && !V[e + " "] && (!I || !I.test(e))) {
          if (1 !== m) p = t, f = e; else if ("object" !== t.nodeName.toLowerCase()) {
            for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") :t.setAttribute("id", a = H), 
            h = T(e), r = h.length, l = de.test(a) ? "#" + a :"[id='" + a + "']"; r--; ) h[r] = l + " " + d(h[r]);
            f = h.join(","), p = ye.test(e) && u(t.parentNode) || t;
          }
          if (f) try {
    ...
    function f(e, t, i) {
      ...
      return t.first ? function(t, i, r) {
        ...
        if (o) {
          ...
          if (c = t[H] || (t[H] = {}), l = c[t.uniqueID] || (c[t.uniqueID] = {}), (a = l[n]) && a[0] === W && a[1] === r) return u[2] = a[2];
    ...
    function g(e, t, i, n, s) {
      for (var r, o = [], a = 0, l = e.length, c = null != t; a < l; a++) (r = e[a]) && (i && !i(r, n, s) || (o.push(r), 
      c && t.push(a)));
      return o;
    }
    function v(e, t, i, s, r, o) {
      return s && !s[H] && (s = v(s)), r && !r[H] && (r = v(r, o)), n(function(n, o, a, l) {
        var c, u, h, d = [], f = [], p = o.length, v = n || m(t || "*", a.nodeType ? [ a ] :a, []), y = !e || !n && t ? v :g(v, d, e, a, l), b = i ? r || (n ? e :p || s) ? [] :o :y;
        if (i && i(y, b, a, l), s) for (c = g(b, f), s(c, [], a, l), u = c.length; u--; ) (h = c[u]) && (b[f[u]] = !(y[f[u]] = h));
        if (n) {
          if (r || e) {
            if (r) {
            ...
            for (u = b.length; u--; ) (h = b[u]) && (c = r ? ee(n, h) :d[u]) > -1 && (n[c] = !(o[c] = h));
          }
        } else b = g(b === o ? b.splice(p, b.length) :b), r ? r(null, o, b, l) :K.apply(o, b);
      });
    }
    function y(e) {
      for (var t, i, n, s = e.length, r = _.relative[e[0].type], o = r || _.relative[" "], a = r ? 1 :0, l = f(function(e) {
        return e === t;
      }, o, !0), c = f(function(e) {
        return ee(t, e) > -1;
      }, o, !0), u = [ function(e, i, n) {
        var s = !r && (n || i !== E) || ((t = i).nodeType ? l(e, i, n) :c(e, i, n));
        return t = null, s;
      } ]; a < s; a++) if (i = _.relative[e[a].type]) u = [ f(p(u), i) ]; else {
        if (i = _.filter[e[a].type].apply(null, e[a].matches), i[H]) {
    ...
    function b(e, i) {
      var s = i.length > 0, r = e.length > 0, o = function(n, o, a, l, c) {
        var u, h, d, f = 0, p = "0", m = n && [], v = [], y = E, b = n || r && _.find.TAG("*", c), w = W += null == y ? 1 :Math.random() || .1, x = b.length;
        for (c && (E = o === P || o || c); p !== x && null != (u = b[p]); p++) {
          if (r && u) {
            for (h = 0, o || u.ownerDocument === P || (D(u), a = !N); d = e[h++]; ) if (d(u, o || P, a)) {
              l.push(u);
              break;
            }
            c && (W = w);
          }
          s && ((u = !d && u) && f--, n && m.push(u));
        }
        if (f += p, s && p !== f) {
          for (h = 0; d = i[h++]; ) d(m, v, o, a);
          if (n) {
            if (f > 0) for (;p--; ) m[p] || v[p] || (v[p] = Q.call(l));
            v = g(v);
          }
    ...
    var w, x, _, C, S, T, k, M, E, j, A, D, P, F, N, I, L, z, O, H = "sizzle" + 1 * new Date(), R = e.document, W = 0, $ = 0, B = i(), q = i(), V = i(), U = function(e, t) {
      return e === t && (A = !0), 0;
    }, Y = 1 << 31, X = {}.hasOwnProperty, G = [], Q = G.pop, Z = G.push, K = G.push, J = G.slice, ee = function(e, t) {
      for (var i = 0, n = e.length; i < n; i++) if (e[i] === t) return i;
      return -1;
    }, te = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ie = "[\\x20\\t\\r\\n\\f]", ne = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", se = "\\[" + ie + "*(" + ne + ")(?:" + ie + "*([*^$|!~]?=)" + ie + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ne + "))|)" + ie + "*\\]", re = ":(" + ne + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + se + ")*)|.*)\\)|)", oe = new RegExp(ie + "+", "g"), ae = new RegExp("^" + ie + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ie + "+$", "g"), le = new RegExp("^" + ie + "*," + ie + "*"), ce = new RegExp("^" + ie + "*([>+~]|" + ie + ")" + ie + "*"), ue = new RegExp("=" + ie + "*([^\\]'\"]*?)" + ie + "*\\]", "g"), he = new RegExp(re), de = new RegExp("^" + ne + "$"), fe = {
      ID:new RegExp("^#(" + ne + ")"),
      CLASS:new RegExp("^\\.(" + ne + ")"),
      TAG:new RegExp("^(" + ne + "|[*])"),
      ATTR:new RegExp("^" + se),
    ...
    }, pe = /^(?:input|select|textarea|button)$/i, me = /^h\d$/i, ge = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, be = /'|\\/g, we = new RegExp("\\\\([\\da-f]{1,6}" + ie + "?|(" + ie + ")|.)", "ig"), xe = function(e, t, i) {
      var n = "0x" + t - 65536;
    ...
    try {
      K.apply(G = J.call(R.childNodes), R.childNodes), G[R.childNodes.length].nodeType;
    } catch (e) {
      K = {
    ...
    x = t.support = {}, S = t.isXML = function(e) {
      ...
      return n !== P && 9 === n.nodeType && n.documentElement ? (P = n, F = P.documentElement, 
      N = !S(P), (i = P.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", _e, !1) :i.attachEvent && i.attachEvent("onunload", _e)), 
      x.attributes = s(function(e) {
        return e.className = "i", !e.getAttribute("className");
      }), x.getElementsByTagName = s(function(e) {
        return e.appendChild(P.createComment("")), !e.getElementsByTagName("*").length;
      }), x.getElementsByClassName = ge.test(P.getElementsByClassName), x.getById = s(function(e) {
        return F.appendChild(e).id = H, !P.getElementsByName || !P.getElementsByName(H).length;
      ...
      }, L = [], I = [], (x.qsa = ge.test(P.querySelectorAll)) && (s(function(e) {
        F.appendChild(e).innerHTML = "<a id='" + H + "'></a><select id='" + H + "-\r\\' msallowcapture=''><option selected=''></option></select>", 
        e.querySelectorAll("[msallowcapture^='']").length && I.push("[*^$]=" + ie + "*(?:''|\"\")"), 
        e.querySelectorAll("[selected]").length || I.push("\\[" + ie + "*(?:value|" + te + ")"), 
        e.querySelectorAll("[id~=" + H + "-]").length || I.push("~="), e.querySelectorAll(":checked").length || I.push(":checked"), 
        e.querySelectorAll("a#" + H + "+*").length || I.push(".#.+[+~]");
      }), s(function(e) {
        var t = P.createElement("input");
        t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && I.push("name" + ie + "*[*^$|!~]?="), 
        e.querySelectorAll(":enabled").length || I.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), 
        I.push(",.*:");
      })), (x.matchesSelector = ge.test(z = F.matches || F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && s(function(e) {
        x.disconnectedMatch = z.call(e, "div"), z.call(e, "[s!='']:x"), L.push("!=", re);
      }), I = I.length && new RegExp(I.join("|")), L = L.length && new RegExp(L.join("|")), 
      t = ge.test(F.compareDocumentPosition), O = t || ge.test(F.contains) ? function(e, t) {
        ...
        1 & i || !x.sortDetached && t.compareDocumentPosition(e) === i ? e === P || e.ownerDocument === R && O(R, e) ? -1 :t === P || t.ownerDocument === R && O(R, t) ? 1 :j ? ee(j, e) - ee(j, t) :0 :4 & i ? -1 :1);
      } :function(e, t) {
        if (e === t) return A = !0, 0;
        var i, n = 0, s = e.parentNode, r = t.parentNode, a = [ e ], l = [ t ];
        if (!s || !r) return e === P ? -1 :t === P ? 1 :s ? -1 :r ? 1 :j ? ee(j, e) - ee(j, t) :0;
        if (s === r) return o(e, t);
      ...
      if ((e.ownerDocument || e) !== P && D(e), i = i.replace(ue, "='$1']"), x.matchesSelector && N && !V[i + " "] && (!L || !L.test(i)) && (!I || !I.test(i))) try {
        var n = z.call(e, i);
      ...
      var i = _.attrHandle[t.toLowerCase()], n = i && X.call(_.attrHandle, t.toLowerCase()) ? i(e, t, !N) :undefined;
      return n !== undefined ? n :x.attributes || !N ? e.getAttribute(t) :(n = e.getAttributeNode(t)) && n.specified ? n.value :null;
    }, t.error = function(e) {
      throw new Error("Syntax error, unrecognized expression: " + e);
    }, t.uniqueSort = function(e) {
      var t, i = [], n = 0, s = 0;
      if (A = !x.detectDuplicates, j = !x.sortStable && e.slice(0), e.sort(U), A) {
      ...
      preFilter:{
        ...
        PSEUDO:function(e) {
          var t, i = !e[6] && e[2];
          return fe.CHILD.test(e[0]) ? null :(e[3] ? e[2] = e[4] || e[5] || "" :i && he.test(i) && (t = T(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t), 
      ...
      filter:{
        ...
        CHILD:function(e, t, i, n, s) {
          ...
          return 1 === n && 0 === s ? function(e) {
            ...
            var c, u, h, d, f, p, m = r !== o ? "nextSibling" :"previousSibling", g = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a, b = !1;
            if (g) {
              if (r) {
                for (;m; ) {
              ...
              if (p = [ o ? g.firstChild :g.lastChild ], o && y) {
                for (d = g, h = d[H] || (d[H] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), 
                c = u[e] || [], f = c[0] === W && c[1], b = f && c[2], d = f && g.childNodes[f]; d = ++f && d && d[m] || (b = f = 0) || p.pop(); ) if (1 === d.nodeType && ++b && d === t) {
                  u[e] = [ W, f, b ];
                  break;
                }
              } else if (y && (d = t, h = d[H] || (d[H] = {}), u = h[d.uniqueID] || (h[d.uniqueID] = {}), 
              c = u[e] || [], f = c[0] === W && c[1], b = f), !1 === b) for (;(d = ++f && d && d[m] || (b = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v :1 !== d.nodeType) || !++b || (y && (h = d[H] || (d[H] = {}), 
              u = h[d.uniqueID] || (h[d.uniqueID] = {}), u[e] = [ W, b ]), d !== t)); ) ;
              return (b -= s) === n || b % n == 0 && b / n >= 0;
            }
          };
        },
        PSEUDO:function(e, i) {
          var s, r = _.pseudos[e] || _.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
          return r[H] ? r(i) :r.length > 1 ? (s = [ e, e, "", i ], _.setFilters.hasOwnProperty(e.toLowerCase()) ? n(function(e, t) {
            for (var n, s = r(e, i), o = s.length; o--; ) n = ee(e, s[o]), e[n] = !(t[n] = s[o]);
          }) :function(e) {
            return r(e, 0, s);
          }) :r;
        }
    ...
    return h.prototype = _.filters = _.pseudos, _.setFilters = new h(), T = t.tokenize = function(e, i) {
      var n, s, r, o, a, l, c, u = q[e + " "];
      if (u) return i ? 0 :u.slice(0);
      for (a = e, l = [], c = _.preFilter; a; ) {
        n && !(s = le.exec(a)) || (s && (a = a.slice(s[0].length) || a), l.push(r = [])), 
        n = !1, (s = ce.exec(a)) && (n = s.shift(), r.push({
          value:n,
          type:s[0].replace(ae, " ")
        }), a = a.slice(n.length));
        for (o in _.filter) !(s = fe[o].exec(a)) || c[o] && !(s = c[o](s)) || (n = s.shift(), 
        r.push({
          value:n,
          type:o,
          matches:s
      ...
      var i, n = [], s = [], r = V[e + " "];
      if (!r) {
        for (t || (t = T(e)), i = t.length; i--; ) r = y(t[i]), r[H] ? n.push(r) :s.push(r);
        r = V(e, b(s, n)), r.selector = e;
      }
      return r;
    }, M = t.select = function(e, t, i, n) {
      var s, r, o, a, l, c = "function" == typeof e && e, h = !n && T(e = c.selector || e);
      if (i = i || [], 1 === h.length) {
        if (r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (o = r[0]).type && x.getById && 9 === t.nodeType && N && _.relative[r[1].type]) {
          if (!(t = (_.find.ID(o.matches[0].replace(we, xe), t) || [])[0])) return i;
          c && (t = t.parentNode), e = e.slice(r.shift().value.length);
        }
        for (s = fe.needsContext.test(e) ? 0 :r.length; s-- && (o = r[s], !_.relative[a = o.type]); ) if ((l = _.find[a]) && (n = l(o.matches[0].replace(we, xe), ye.test(r[0].type) && u(t.parentNode) || t))) {
          if (r.splice(s, 1), !(e = n.length && d(r))) return K.apply(i, n), i;
          break;
        }
      }
      return (c || k(e, h))(n, t, !N, i, !t || ye.test(e) && u(t.parentNode) || t), i;
    }, x.sortStable = H.split("").sort(U).join("") === H, x.detectDuplicates = !!A, 
    D(), x.sortDetached = s(function(e) {
  ...
  fe.text = ye.getText, fe.isXMLDoc = ye.isXML, fe.contains = ye.contains;
  var be = function(e, t, i) {
    for (var n = [], s = i !== undefined; (e = e[t]) && 9 !== e.nodeType; ) if (1 === e.nodeType) {
    ...
    return i;
  }, xe = fe.expr.match.needsContext, _e = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Ce = /^.[^:#\[\.,]*$/;
  fe.filter = function(e, t, i) {
    ...
    find:function(e) {
      ...
      if ("string" != typeof e) return this.pushStack(fe(e).filter(function() {
        for (t = 0; t < s; t++) if (fe.contains(n[t], this)) return !0;
      }));
      for (t = 0; t < s; t++) fe.find(e, n[t], i);
      return i = this.pushStack(s > 1 ? fe.unique(i) :i), i.selector = this.selector ? this.selector + " " + e :e, 
      i;
    },
    filter:function(e) {
  ...
  (fe.fn.init = function(e, t, i) {
    ...
    if (i = i || Se, "string" == typeof e) {
      if (!(n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [ null, e, null ] :Te.exec(e)) || !n[1] && t) return !t || t.jquery ? (t || i).find(e) :this.constructor(t).find(e);
      if (n[1]) {
        if (t = t instanceof fe ? t[0] :t, fe.merge(this, fe.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t :ne, !0)), 
        _e.test(n[1]) && fe.isPlainObject(t)) for (n in t) fe.isFunction(this[n]) ? this[n](t[n]) :this.attr(n, t[n]);
        return this;
      }
      if ((s = ne.getElementById(n[2])) && s.parentNode) {
        if (s.id !== n[2]) return Se.find(e);
        this.length = 1, this[0] = s;
      }
      return this.context = ne, this.selector = e, this;
    }
    return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) :fe.isFunction(e) ? "undefined" != typeof i.ready ? i.ready(e) :e(fe) :(e.selector !== undefined && (this.selector = e.selector, 
    this.context = e.context), fe.makeArray(e, this));
  }).prototype = fe.fn, Se = fe(ne);
  var ke = /^(?:parents|prev(?:Until|All))/, Me = {
    children:!0,
    contents:!0,
    next:!0,
    prev:!0
  ...
  fe.fn.extend({
    ...
    closest:function(e, t) {
      for (var i, n = 0, s = this.length, r = [], o = xe.test(e) || "string" != typeof e ? fe(e, t || this.context) :0; n < s; n++) for (i = this[n]; i && i !== t; i = i.parentNode) if (i.nodeType < 11 && (o ? o.index(i) > -1 :1 === i.nodeType && fe.find.matchesSelector(i, e))) {
        r.push(i);
        break;
      }
    ...
    fe.fn[e] = function(i, n) {
      ...
      return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (s = fe.filter(n, s)), 
      this.length > 1 && (Me[e] || (s = fe.uniqueSort(s)), ke.test(e) && (s = s.reverse())), 
      this.pushStack(s);
    };
  });
  var Ee = /\S+/g;
  fe.Callbacks = function(e) {
    ...
    var t, i, n, s, o = [], a = [], l = -1, c = function() {
      for (s = e.once, n = t = !0; a.length; l = -1) for (i = a.shift(); ++l < o.length; ) !1 === o[l].apply(i[0], i[1]) && e.stopOnFalse && (l = o.length, 
      i = !1);
      ...
      add:function() {
        return o && (i && !t && (l = o.length - 1, a.push(i)), function t(i) {
          fe.each(i, function(i, n) {
            fe.isFunction(n) ? e.unique && u.has(n) || o.push(n) :n && n.length && "string" !== fe.type(n) && t(n);
          });
      ...
      fireWith:function(e, i) {
        return s || (i = i || [], i = [ e, i.slice ? i.slice() :i ], a.push(i), t || c()), 
        this;
      },
      fire:function() {
    ...
    Deferred:function(e) {
      var t = [ [ "resolve", "done", fe.Callbacks("once memory"), "resolved" ], [ "reject", "fail", fe.Callbacks("once memory"), "rejected" ], [ "notify", "progress", fe.Callbacks("memory") ] ], i = "pending", n = {
        state:function() {
          return i;
        },
        always:function() {
          ...
          return fe.Deferred(function(i) {
            fe.each(t, function(t, r) {
              ...
              s[r[1]](function() {
                ...
                e && fe.isFunction(e.promise) ? e.promise().progress(i.notify).done(i.resolve).fail(i.reject) :i[r[0] + "With"](this === n ? i.promise() :this, o ? [ e ] :arguments);
              });
            }), e = null;
          }).promise();
        },
      ...
      return n.pipe = n.then, fe.each(t, function(e, r) {
        var o = r[2], a = r[3];
    ...
    when:function(e) {
      var t, i, n, s = 0, r = se.call(arguments), o = r.length, a = 1 !== o || e && fe.isFunction(e.promise) ? o :0, l = 1 === a ? e :fe.Deferred(), c = function(e, i, n) {
        return function(s) {
          i[e] = this, n[e] = arguments.length > 1 ? se.call(arguments) :s, n === t ? l.notifyWith(i, n) :--a || l.resolveWith(i, n);
        };
      };
      if (o > 1) for (t = new Array(o), i = new Array(o), n = new Array(o); s < o; s++) r[s] && fe.isFunction(r[s].promise) ? r[s].promise().progress(c(s, i, t)).done(c(s, n, r)).fail(l.reject) :--a;
  ...
  fe.fn.ready = function(e) {
    ...
    ready:function(e) {
      (!0 === e ? --fe.readyWait :fe.isReady) || (fe.isReady = !0, !0 !== e && --fe.readyWait > 0 || (je.resolveWith(ne, [ fe ]), 
      fe.fn.triggerHandler && (fe(ne).triggerHandler("ready"), fe(ne).off("ready"))));
    }
  }), fe.ready.promise = function(t) {
    if (!je) if (je = fe.Deferred(), "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll) e.setTimeout(fe.ready); else if (ne.addEventListener) ne.addEventListener("DOMContentLoaded", a), 
  ...
  var Ae;
  for (Ae in fe(he)) break;
  he.ownFirst = "0" === Ae, he.inlineBlockNeedsLayout = !1, fe(function() {
    var e, t, i, n;
    (i = ne.getElementsByTagName("body")[0]) && i.style && (t = ne.createElement("div"), 
    n = ne.createElement("div"), n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
    i.appendChild(n).appendChild(t), "undefined" != typeof t.style.zoom && (t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", 
    he.inlineBlockNeedsLayout = e = 3 === t.offsetWidth, e && (i.style.zoom = 1)), i.removeChild(n));
  }), function() {
  ...
  fe.extend({
    ...
    data:function(e, t) {
      ...
      if (e === undefined) {
        if (this.length && (s = fe.data(r), 1 === r.nodeType && !fe._data(r, "parsedAttrs"))) {
          for (i = o.length; i--; ) o[i] && (n = o[i].name, 0 === n.indexOf("data-") && (n = fe.camelCase(n.slice(5)), 
          l(r, n, s[n])));
    ...
    queue:function(e, t, i) {
      var n;
      if (e) return t = (t || "fx") + "queue", n = fe._data(e, t), i && (!n || fe.isArray(i) ? n = fe._data(e, t, fe.makeArray(i)) :n.push(i)), 
      n || [];
    },
    dequeue:function(e, t) {
      t = t || "fx";
      var i = fe.queue(e, t), n = i.length, s = i.shift(), r = fe._queueHooks(e, t), o = function() {
        fe.dequeue(e, t);
      };
    ...
    promise:function(e, t) {
      var i, n = 1, s = fe.Deferred(), r = this, o = this.length, a = function() {
        --n || s.resolveWith(r, [ r ]);
      };
      for ("string" != typeof e && (t = e, e = undefined), e = e || "fx"; o--; ) (i = fe._data(r[o], e + "queueHooks")) && i.empty && (n++, 
      i.empty.add(a));
    ...
    he.shrinkWrapBlocks = function() {
      ...
      n = ne.createElement("div"), n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
      i.appendChild(n).appendChild(t), "undefined" != typeof t.style.zoom && (t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", 
      t.appendChild(ne.createElement("div")).style.width = "5px", e = 3 !== t.offsetWidth), 
      i.removeChild(n), e) :void 0;
    };
  }();
  var Ne = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ie = new RegExp("^(?:([+-])=|)(" + Ne + ")([a-z%]*)$", "i"), Le = [ "Top", "Right", "Bottom", "Left" ], ze = function(e, t) {
    return e = t || e, "none" === fe.css(e, "display") || !fe.contains(e.ownerDocument, e);
  }, Oe = function(e, t, i, n, s, r, o) {
    var a = 0, l = e.length, c = null == i;
    if ("object" === fe.type(i)) {
      s = !0;
      for (a in i) Oe(e, t, a, i[a], !0, r, o);
    } else if (n !== undefined && (s = !0, fe.isFunction(n) || (o = !0), c && (o ? (t.call(e, n), 
  ...
  }, He = /^(?:checkbox|radio)$/i, Re = /<([\w:-]+)/, We = /^$|\/(?:java|ecma)script/i, $e = /^\s+/, Be = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
  !function() {
    ...
    he.htmlSerialize = !!e.getElementsByTagName("link").length, he.html5Clone = "<:nav></:nav>" !== ne.createElement("nav").cloneNode(!0).outerHTML, 
    i.type = "checkbox", i.checked = !0, t.appendChild(i), he.appendChecked = i.checked, 
    e.innerHTML = "<textarea>x</textarea>", he.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue, 
    t.appendChild(e), i = ne.createElement("input"), i.setAttribute("type", "radio"), 
    i.setAttribute("checked", "checked"), i.setAttribute("name", "t"), e.appendChild(i), 
    he.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, he.noCloneEvent = !!e.addEventListener, 
    e[fe.expando] = 1, he.attributes = !e.getAttribute(fe.expando);
  }();
  var qe = {
  ...
  !function() {
    ...
    for (t in {
      ...
      change:!0,
      focusin:!0
    }) i = "on" + t, (he[t] = i in e) || (n.setAttribute(i, "t"), he[t] = !1 === n.attributes[i].expando);
    n = null;
  }();
  var Ye = /^(?:input|select|textarea)$/i, Xe = /^key/, Ge = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Qe = /^(?:focusinfocus|focusoutblur)$/, Ze = /^([^.]*)(?:\.(.+)|)/;
  fe.event = {
    global:{},
    add:function(e, t, i, n, s) {
      var r, o, a, l, c, u, h, d, f, p, m, g = fe._data(e);
      if (g) {
        for (i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = fe.guid++), 
        (o = g.events) || (o = g.events = {}), (u = g.handle) || (u = g.handle = function(e) {
          return void 0 === fe || e && fe.event.triggered === e.type ? undefined :fe.event.dispatch.apply(u.elem, arguments);
        }, u.elem = e), t = (t || "").match(Ee) || [ "" ], a = t.length; a--; ) r = Ze.exec(t[a]) || [], 
        f = m = r[1], p = (r[2] || "").split(".").sort(), f && (c = fe.event.special[f] || {}, 
        f = (s ? c.delegateType :c.bindType) || f, c = fe.event.special[f] || {}, h = fe.extend({
          type:f,
          origType:m,
          data:n,
          handler:i,
          ...
          namespace:p.join(".")
        }, l), (d = o[f]) || (d = o[f] = [], d.delegateCount = 0, c.setup && !1 !== c.setup.call(e, n, p, u) || (e.addEventListener ? e.addEventListener(f, u, !1) :e.attachEvent && e.attachEvent("on" + f, u))), 
        c.add && (c.add.call(e, h), h.handler.guid || (h.handler.guid = i.guid)), s ? d.splice(d.delegateCount++, 0, h) :d.push(h), 
        fe.event.global[f] = !0);
        e = null;
      }
    },
    remove:function(e, t, i, n, s) {
      var r, o, a, l, c, u, h, d, f, p, m, g = fe.hasData(e) && fe._data(e);
      if (g && (u = g.events)) {
        for (t = (t || "").match(Ee) || [ "" ], c = t.length; c--; ) if (a = Ze.exec(t[c]) || [], 
        f = m = a[1], p = (a[2] || "").split(".").sort(), f) {
          for (h = fe.event.special[f] || {}, f = (n ? h.delegateType :h.bindType) || f, d = u[f] || [], 
          a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = d.length; r--; ) o = d[r], 
          !s && m !== o.origType || i && i.guid !== o.guid || a && !a.test(o.namespace) || n && n !== o.selector && ("**" !== n || !o.selector) || (d.splice(r, 1), 
          o.selector && d.delegateCount--, h.remove && h.remove.call(e, o));
          l && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, g.handle) || fe.removeEvent(e, f, g.handle), 
          delete u[f]);
    ...
    trigger:function(t, i, n, s) {
      var r, o, a, l, c, u, h, d = [ n || ne ], f = ue.call(t, "type") ? t.type :t, p = ue.call(t, "namespace") ? t.namespace.split(".") :[];
      if (a = u = n = n || ne, 3 !== n.nodeType && 8 !== n.nodeType && !Qe.test(f + fe.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), 
      f = p.shift(), p.sort()), o = f.indexOf(":") < 0 && "on" + f, t = t[fe.expando] ? t :new fe.Event(f, "object" == typeof t && t), 
      t.isTrigger = s ? 2 :3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") :null, 
      t.result = undefined, t.target || (t.target = n), i = null == i ? [ t ] :fe.makeArray(i, [ t ]), 
      c = fe.event.special[f] || {}, s || !c.trigger || !1 !== c.trigger.apply(n, i))) {
        if (!s && !c.noBubble && !fe.isWindow(n)) {
          for (l = c.delegateType || f, Qe.test(l + f) || (a = a.parentNode); a; a = a.parentNode) d.push(a), 
          u = a;
          u === (n.ownerDocument || ne) && d.push(u.defaultView || u.parentWindow || e);
        }
        for (h = 0; (a = d[h++]) && !t.isPropagationStopped(); ) t.type = h > 1 ? l :c.bindType || f, 
        r = (fe._data(a, "events") || {})[t.type] && fe._data(a, "handle"), r && r.apply(a, i), 
        (r = o && a[o]) && r.apply && De(a) && (t.result = r.apply(a, i), !1 === t.result && t.preventDefault());
        if (t.type = f, !s && !t.isDefaultPrevented() && (!c._default || !1 === c._default.apply(d.pop(), i)) && De(n) && o && n[f] && !fe.isWindow(n)) {
    ...
    dispatch:function(e) {
      e = fe.event.fix(e);
      var t, i, n, s, r, o = [], a = se.call(arguments), l = (fe._data(this, "events") || {})[e.type] || [], c = fe.event.special[e.type] || {};
      if (a[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
        for (o = fe.event.handlers.call(this, e, l), t = 0; (s = o[t++]) && !e.isPropagationStopped(); ) for (e.currentTarget = s.elem, 
        i = 0; (r = s.handlers[i++]) && !e.isImmediatePropagationStopped(); ) e.rnamespace && !e.rnamespace.test(r.namespace) || (e.handleObj = r, 
        e.data = r.data, (n = ((fe.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, a)) !== undefined && !1 === (e.result = n) && (e.preventDefault(), 
        e.stopPropagation()));
    ...
    handlers:function(e, t) {
      ...
      if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1)) for (;l != this; l = l.parentNode || this) if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
        for (n = [], i = 0; i < a; i++) r = t[i], s = r.selector + " ", n[s] === undefined && (n[s] = r.needsContext ? fe(s, this).index(l) > -1 :fe.find(s, this, null, [ l ]).length), 
        n[s] && n.push(r);
        n.length && o.push({
          elem:l,
          handlers:n
    ...
    fix:function(e) {
      ...
      for (o || (this.fixHooks[s] = o = Ge.test(s) ? this.mouseHooks :Xe.test(s) ? this.keyHooks :{}), 
      n = o.props ? this.props.concat(o.props) :this.props, e = new fe.Event(r), t = n.length; t--; ) i = n[t], 
      e[i] = r[i];
      return e.target || (e.target = r.srcElement || ne), 3 === e.target.nodeType && (e.target = e.target.parentNode), 
    ...
    mouseHooks:{
      ...
      filter:function(e, t) {
        ...
        !e.relatedTarget && o && (e.relatedTarget = o === e.target ? t.toElement :o), e.which || r === undefined || (e.which = 1 & r ? 1 :2 & r ? 3 :4 & r ? 2 :0), 
        e;
      }
    },
    special:{
    ...
    stopPropagation:function() {
      var e = this.originalEvent;
      this.isPropagationStopped = y, e && !this.isSimulated && (e.stopPropagation && e.stopPropagation(), 
      e.cancelBubble = !0);
    },
    ...
    fe.event.special[e] = {
      ...
      handle:function(e) {
        ...
        return s && (s === n || fe.contains(n, s)) || (e.type = r.origType, i = r.handler.apply(this, arguments), 
        e.type = t), i;
      }
    };
    ...
    setup:function() {
      ...
      fe.event.add(this, "click._submit keypress._submit", function(e) {
        var t = e.target, i = fe.nodeName(t, "input") || fe.nodeName(t, "button") ? fe.prop(t, "form") :undefined;
    ...
    fe.event.special[t] = {
      setup:function() {
        var n = this.ownerDocument || this, s = fe._data(n, t);
        s || n.addEventListener(e, i, !0), fe._data(n, t, (s || 0) + 1);
      },
      teardown:function() {
        var n = this.ownerDocument || this, s = fe._data(n, t) - 1;
        s ? fe._data(n, t, s) :(n.removeEventListener(e, i, !0), fe._removeData(n, t));
      }
    };
  }), fe.fn.extend({
    on:function(e, t, i, n) {
    ...
    off:function(e, t, i) {
      var n, s;
      if (e && e.preventDefault && e.handleObj) return n = e.handleObj, fe(e.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace :n.origType, n.selector, n.handler), 
      this;
      if ("object" == typeof e) {
        for (s in e) this.off(s, t, e[s]);
        return this;
      }
      return !1 !== t && "function" != typeof t || (i = t, t = undefined), !1 === i && (i = b), 
      this.each(function() {
  ...
  var Ke = / jQuery\d+="(?:null|\d+)"/g, Je = new RegExp("<(?:" + Be + ")[\\s/>]", "i"), et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, tt = /<script|<style|<link/i, it = /checked\s*(?:[^=]|=\s*.checked.)/i, nt = /^true\/(.*)/, st = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, rt = f(ne), ot = rt.appendChild(ne.createElement("div"));
  fe.extend({
    htmlPrefilter:function(e) {
      return e.replace(et, "<$1></$2>");
    },
    clone:function(e, t, i) {
      var n, s, r, o, a, l = fe.contains(e.ownerDocument, e);
      if (he.html5Clone || fe.isXMLDoc(e) || !Je.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) :(ot.innerHTML = e.outerHTML, 
      ot.removeChild(r = ot.firstChild)), !(he.noCloneEvent && he.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || fe.isXMLDoc(e))) for (n = p(r), 
      a = p(e), o = 0; null != (s = a[o]); ++o) n[o] && k(s, n[o]);
      if (t) if (i) for (a = a || p(e), n = n || p(r), o = 0; null != (s = a[o]); o++) T(s, n[o]); else T(e, r);
      return n = p(r, "script"), n.length > 0 && m(n, !l && p(e, "script")), n = a = s = null, 
      r;
    },
    cleanData:function(e, t) {
      for (var i, n, s, r, o = 0, a = fe.expando, l = fe.cache, c = he.attributes, u = fe.event.special; null != (i = e[o]); o++) if ((t || De(i)) && (s = i[a], 
      r = s && l[s])) {
        if (r.events) for (n in r.events) u[n] ? fe.event.remove(i, n) :fe.removeEvent(i, n, r.handle);
        l[s] && (delete l[s], c || "undefined" == typeof i.removeAttribute ? i[a] = undefined :i.removeAttribute(a), 
        ie.push(s));
      }
    }
  }), fe.fn.extend({
    ...
    html:function(e) {
      return Oe(this, function(e) {
        ...
        if ("string" == typeof e && !tt.test(e) && (he.htmlSerialize || !Je.test(e)) && (he.leadingWhitespace || !$e.test(e)) && !qe[(Re.exec(e) || [ "", "" ])[1].toLowerCase()]) {
          e = fe.htmlPrefilter(e);
          try {
            for (;i < n; i++) t = this[i] || {}, 1 === t.nodeType && (fe.cleanData(p(t, !1)), 
            t.innerHTML = e);
            t = 0;
          } catch (e) {}
        }
    ...
    replaceWith:function() {
      ...
      return M(this, arguments, function(t) {
        ...
        fe.inArray(this, e) < 0 && (fe.cleanData(p(this)), i && i.replaceChild(t, this));
      }, e);
    }
  }), fe.each({
    appendTo:"append",
    ...
    fe.fn[e] = function(e) {
      for (var i, n = 0, s = [], r = fe(e), o = r.length - 1; n <= o; n++) i = n === o ? this :this.clone(!0), 
      fe(r[n])[t](i), oe.apply(s, i.get());
  ...
  var at, lt = {
    HTML:"block",
    BODY:"block"
  }, ct = /^margin/, ut = new RegExp("^(" + Ne + ")(?!px)[a-z%]+$", "i"), ht = function(e, t, i, n) {
    var s, r, o = {};
  ...
  !function() {
    function t() {
      ...
      h.appendChild(l), c.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", 
      i = s = a = !1, n = o = !0, e.getComputedStyle && (u = e.getComputedStyle(c), i = "1%" !== (u || {}).top, 
      a = "2px" === (u || {}).marginLeft, s = "4px" === (u || {
        width:"4px"
      }).width, c.style.marginRight = "50%", n = "4px" === (u || {
        marginRight:"4px"
      }).marginRight, t = c.appendChild(ne.createElement("div")), t.style.cssText = c.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", 
      t.style.marginRight = t.style.width = "0", c.style.width = "1px", o = !parseFloat((e.getComputedStyle(t) || {}).marginRight), 
      c.removeChild(t)), c.style.display = "none", r = 0 === c.getClientRects().length, 
      r && (c.style.display = "", c.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", 
      t = c.getElementsByTagName("td"), t[0].style.cssText = "margin:0;border:0;padding:0;display:none", 
      (r = 0 === t[0].offsetHeight) && (t[0].style.display = "", t[1].style.display = "none", 
      r = 0 === t[0].offsetHeight)), h.removeChild(l);
    }
    var i, n, s, r, o, a, l = ne.createElement("div"), c = ne.createElement("div");
    c.style && (c.style.cssText = "float:left;opacity:.5", he.opacity = "0.5" === c.style.opacity, 
    he.cssFloat = !!c.style.cssFloat, c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", 
    he.clearCloneStyle = "content-box" === c.style.backgroundClip, l = ne.createElement("div"), 
    l.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", 
    c.innerHTML = "", l.appendChild(c), he.boxSizing = "" === c.style.boxSizing || "" === c.style.MozBoxSizing || "" === c.style.WebkitBoxSizing, 
    fe.extend(he, {
  ...
  var ft, pt, mt = /^(top|right|bottom|left)$/;
  e.getComputedStyle ? (ft = function(t) {
    var i = t.ownerDocument.defaultView;
    return i && i.opener || (i = e), i.getComputedStyle(t);
  }, pt = function(e, t, i) {
    var n, s, r, o, a = e.style;
    return i = i || ft(e), o = i ? i.getPropertyValue(t) || i[t] :undefined, "" !== o && o !== undefined || fe.contains(e.ownerDocument, e) || (o = fe.style(e, t)), 
    i && !he.pixelMarginRight() && ut.test(o) && ct.test(t) && (n = a.width, s = a.minWidth, 
    r = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = i.width, a.width = n, 
    a.minWidth = s, a.maxWidth = r), o === undefined ? o :o + "";
  }) :dt.currentStyle && (ft = function(e) {
    return e.currentStyle;
  }, pt = function(e, t, i) {
    var n, s, r, o, a = e.style;
    return i = i || ft(e), o = i ? i[t] :undefined, null == o && a && a[t] && (o = a[t]), 
    ut.test(o) && !mt.test(t) && (n = a.left, s = e.runtimeStyle, r = s && s.left, r && (s.left = e.currentStyle.left), 
    a.left = "fontSize" === t ? "1em" :o, o = a.pixelLeft + "px", a.left = n, r && (s.left = r)), 
    o === undefined ? o :o + "" || "auto";
  });
  var gt = /alpha\([^)]*\)/i, vt = /opacity\s*=\s*([^)]*)/i, yt = /^(none|table(?!-c[ea]).+)/, bt = new RegExp("^(" + Ne + ")(.*)$", "i"), wt = {
    position:"absolute",
    visibility:"hidden",
    display:"block"
  }, xt = {
    letterSpacing:"0",
    fontWeight:"400"
  }, _t = [ "Webkit", "O", "Moz", "ms" ], Ct = ne.createElement("div").style;
  fe.extend({
    cssHooks:{
      opacity:{
        get:function(e, t) {
    ...
    style:function(e, t, i, n) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var s, r, o, a = fe.camelCase(t), l = e.style;
        if (t = fe.cssProps[a] || (fe.cssProps[a] = P(a) || a), o = fe.cssHooks[t] || fe.cssHooks[a], 
        i === undefined) return o && "get" in o && (s = o.get(e, !1, n)) !== undefined ? s :l[t];
        if (r = typeof i, "string" === r && (s = Ie.exec(i)) && s[1] && (i = d(e, t, s), 
        r = "number"), null != i && i === i && ("number" === r && (i += s && s[3] || (fe.cssNumber[a] ? "" :"px")), 
        he.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (l[t] = "inherit"), 
        !(o && "set" in o && (i = o.set(e, i, n)) === undefined))) try {
          l[t] = i;
        } catch (e) {}
      }
    },
    css:function(e, t, i, n) {
      var s, r, o, a = fe.camelCase(t);
      return t = fe.cssProps[a] || (fe.cssProps[a] = P(a) || a), o = fe.cssHooks[t] || fe.cssHooks[a], 
      o && "get" in o && (r = o.get(e, !0, i)), r === undefined && (r = pt(e, t, n)), 
      "normal" === r && t in xt && (r = xt[t]), "" === i || i ? (s = parseFloat(r), !0 === i || isFinite(s) ? s || 0 :r) :r;
    }
  }), fe.each([ "height", "width" ], function(e, t) {
    fe.cssHooks[t] = {
      get:function(e, i, n) {
        if (i) return yt.test(fe.css(e, "display")) && 0 === e.offsetWidth ? ht(e, wt, function() {
          return L(e, t, n);
        }) :L(e, t, n);
      },
      set:function(e, i, n) {
        var s = n && ft(e);
        return N(e, i, n ? I(e, t, n, he.boxSizing && "border-box" === fe.css(e, "boxSizing", !1, s), s) :0);
      }
    };
    ...
    set:function(e, t) {
      var i = e.style, n = e.currentStyle, s = fe.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" :"", r = n && n.filter || i.filter || "";
      i.zoom = 1, (t >= 1 || "" === t) && "" === fe.trim(r.replace(gt, "")) && i.removeAttribute && (i.removeAttribute("filter"), 
      "" === t || n && !n.filter) || (i.filter = gt.test(r) ? r.replace(gt, s) :r + " " + s);
    }
  }), fe.cssHooks.marginRight = D(he.reliableMarginRight, function(e, t) {
    if (t) return ht(e, {
      display:"inline-block"
    }, pt, [ e, "marginRight" ]);
  }), fe.cssHooks.marginLeft = D(he.reliableMarginLeft, function(e, t) {
    if (t) return (parseFloat(pt(e, "marginLeft")) || (fe.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - ht(e, {
      marginLeft:0
    }, function() {
    ...
    css:function(e, t) {
      return Oe(this, function(e, t, i) {
        var n, s, r = {}, o = 0;
        if (fe.isArray(t)) {
          for (n = ft(e), s = t.length; o < s; o++) r[t[o]] = fe.css(e, t[o], !1, n);
          return r;
        }
    ...
    init:function(e, t, i, n, s, r) {
      this.elem = e, this.prop = i, this.easing = s || fe.easing._default, this.options = t, 
      this.start = this.now = this.cur(), this.end = n, this.unit = r || (fe.cssNumber[i] ? "" :"px");
    },
    cur:function() {
  ...
  var St, Tt, kt = /^(?:toggle|show|hide)$/, Mt = /queueHooks$/;
  fe.Animation = fe.extend(B, {
    tweeners:{
      "*":[ function(e, t) {
        var i = this.createTween(e, t);
        return d(i.elem, e, Ie.exec(t), i), i;
      } ]
    },
    tweener:function(e, t) {
      fe.isFunction(e) ? (t = e, e = [ "*" ]) :e = e.match(Ee);
      for (var i, n = 0, s = e.length; n < s; n++) i = e[n], B.tweeners[i] = B.tweeners[i] || [], 
    ...
    animate:function(e, t, i, n) {
      var s = fe.isEmptyObject(e), r = fe.speed(t, i, n), o = function() {
        var t = B(this, fe.extend({}, e), r);
        (s || fe._data(this, "finish")) && t.stop(!0);
      };
    ...
    stop:function(e, t, i) {
      ...
      return "string" != typeof e && (i = t, t = e, e = undefined), t && !1 !== e && this.queue(e || "fx", []), 
      this.each(function() {
        var t = !0, s = null != e && e + "queueHooks", r = fe.timers, o = fe._data(this);
        if (s) o[s] && o[s].stop && n(o[s]); else for (s in o) o[s] && o[s].stop && Mt.test(s) && n(o[s]);
    ...
    finish:function(e) {
      return !1 !== e && (e = e || "fx"), this.each(function() {
        var t, i = fe._data(this), n = i[e + "queue"], s = i[e + "queueHooks"], r = fe.timers, o = n ? n.length :0;
        for (i.finish = !0, fe.queue(this, e, []), s && s.stop && s.stop.call(this, !0), 
    ...
    for (St = fe.now(); i < t.length; i++) (e = t[i])() || t[i] !== e || t.splice(i--, 1);
    ...
    var e, t = ne.createElement("input"), i = ne.createElement("div"), n = ne.createElement("select"), s = n.appendChild(ne.createElement("option"));
    i = ne.createElement("div"), i.setAttribute("className", "t"), i.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", 
    e = i.getElementsByTagName("a")[0], t.setAttribute("type", "checkbox"), i.appendChild(t), 
    e = i.getElementsByTagName("a")[0], e.style.cssText = "top:1px", he.getSetAttribute = "t" !== i.className, 
    he.style = /top/.test(e.getAttribute("style")), he.hrefNormalized = "/a" === e.getAttribute("href"), 
    he.checkOn = !!t.value, he.optSelected = s.selected, he.enctype = !!ne.createElement("form").enctype, 
    n.disabled = !0, he.optDisabled = !s.disabled, t = ne.createElement("input"), t.setAttribute("value", ""), 
    ...
    val:function(e) {
      var t, i, n, s = this[0];
      {
        if (arguments.length) return n = fe.isFunction(e), this.each(function(i) {
          var s;
          1 === this.nodeType && (s = n ? e.call(this, i, fe(this).val()) :e, null == s ? s = "" :"number" == typeof s ? s += "" :fe.isArray(s) && (s = fe.map(s, function(e) {
            return null == e ? "" :e + "";
          })), (t = fe.valHooks[this.type] || fe.valHooks[this.nodeName.toLowerCase()]) && "set" in t && t.set(this, s, "value") !== undefined || (this.value = s));
        });
        if (s) return (t = fe.valHooks[s.type] || fe.valHooks[s.nodeName.toLowerCase()]) && "get" in t && (i = t.get(s, "value")) !== undefined ? i :(i = s.value, 
        "string" == typeof i ? i.replace(Et, "") :null == i ? "" :i);
      }
    }
  }), fe.extend({
    valHooks:{
      ...
      select:{
        get:function(e) {
          for (var t, i, n = e.options, s = e.selectedIndex, r = "select-one" === e.type || s < 0, o = r ? null :[], a = r ? s + 1 :n.length, l = s < 0 ? a :r ? s :0; l < a; l++) if (i = n[l], 
          (i.selected || l === s) && (he.optDisabled ? !i.disabled :null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !fe.nodeName(i.parentNode, "optgroup"))) {
        ...
        set:function(e, t) {
          for (var i, n, s = e.options, r = fe.makeArray(t), o = s.length; o--; ) if (n = s[o], 
          fe.inArray(fe.valHooks.option.get(n), r) >= 0) try {
            n.selected = i = !0;
          } catch (e) {
            n.scrollHeight;
          } else n.selected = !1;
  ...
  var jt, At, Dt = fe.expr.attrHandle, Pt = /^(?:checked|selected)$/i, Ft = he.getSetAttribute, Nt = he.input;
  fe.fn.extend({
    attr:function(e, t) {
    ...
    attr:function(e, t, i) {
      ...
      if (3 !== r && 8 !== r && 2 !== r) return "undefined" == typeof e.getAttribute ? fe.prop(e, t, i) :(1 === r && fe.isXMLDoc(e) || (t = t.toLowerCase(), 
      s = fe.attrHooks[t] || (fe.expr.match.bool.test(t) ? At :jt)), i !== undefined ? null === i ? void fe.removeAttr(e, t) :s && "set" in s && (n = s.set(e, i, t)) !== undefined ? n :(e.setAttribute(t, i + ""), 
      i) :s && "get" in s && null !== (n = s.get(e, t)) ? n :(n = fe.find.attr(e, t), 
      null == n ? undefined :n));
    },
    attrHooks:{
      type:{
    ...
    removeAttr:function(e, t) {
      var i, n, s = 0, r = t && t.match(Ee);
      if (r && 1 === e.nodeType) for (;i = r[s++]; ) n = fe.propFix[i] || i, fe.expr.match.bool.test(i) ? Nt && Ft || !Pt.test(i) ? e[n] = !1 :e[fe.camelCase("default-" + i)] = e[n] = !1 :fe.attr(e, i, ""), 
      e.removeAttribute(Ft ? i :n);
    }
  }), At = {
    set:function(e, t, i) {
      return !1 === t ? fe.removeAttr(e, i) :Nt && Ft || !Pt.test(i) ? e.setAttribute(!Ft && fe.propFix[i] || i, i) :e[fe.camelCase("default-" + i)] = e[i] = !0, 
      i;
    }
  }, fe.each(fe.expr.match.bool.source.match(/\w+/g), function(e, t) {
    var i = Dt[t] || fe.find.attr;
    Nt && Ft || !Pt.test(t) ? Dt[t] = function(e, t, n) {
      var s, r;
      return n || (r = Dt[t], Dt[t] = s, s = null != i(e, t, n) ? t.toLowerCase() :null, 
      Dt[t] = r), s;
    } :Dt[t] = function(e, t, i) {
      if (!i) return e[fe.camelCase("default-" + t)] ? t.toLowerCase() :null;
    };
  }), Nt && Ft || (fe.attrHooks.value = {
    set:function(e, t, i) {
    ...
    set:function(e, t, i) {
      ...
      if (n || e.setAttributeNode(n = e.ownerDocument.createAttribute(i)), n.value = t += "", 
      "value" === i || t === e.getAttribute(i)) return t;
    }
  ...
  var It = /^(?:input|select|textarea|button|object)$/i, Lt = /^(?:a|area)$/i;
  fe.fn.extend({
    prop:function(e, t) {
    ...
    prop:function(e, t, i) {
      ...
      s = fe.propHooks[t]), i !== undefined ? s && "set" in s && (n = s.set(e, i, t)) !== undefined ? n :e[t] = i :s && "get" in s && null !== (n = s.get(e, t)) ? n :e[t];
    },
    propHooks:{
      tabIndex:{
        get:function(e) {
  ...
  fe.fn.extend({
    addClass:function(e) {
      ...
      if ("string" == typeof e && e) for (t = e.match(Ee) || []; i = this[l++]; ) if (s = q(i), 
      n = 1 === i.nodeType && (" " + s + " ").replace(zt, " ")) {
        for (o = 0; r = t[o++]; ) n.indexOf(" " + r + " ") < 0 && (n += r + " ");
        a = fe.trim(n), s !== a && fe.attr(i, "class", a);
      }
      return this;
    },
    removeClass:function(e) {
      ...
      if ("string" == typeof e && e) for (t = e.match(Ee) || []; i = this[l++]; ) if (s = q(i), 
      n = 1 === i.nodeType && (" " + s + " ").replace(zt, " ")) {
        for (o = 0; r = t[o++]; ) for (;n.indexOf(" " + r + " ") > -1; ) n = n.replace(" " + r + " ", " ");
        a = fe.trim(n), s !== a && fe.attr(i, "class", a);
      }
      return this;
    },
    toggleClass:function(e, t) {
      ...
      return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) :this.removeClass(e) :fe.isFunction(e) ? this.each(function(i) {
        fe(this).toggleClass(e.call(this, i, q(this), t), t);
      }) :this.each(function() {
        var t, n, s, r;
        if ("string" === i) for (n = 0, s = fe(this), r = e.match(Ee) || []; t = r[n++]; ) s.hasClass(t) ? s.removeClass(t) :s.addClass(t); else e !== undefined && "boolean" !== i || (t = q(this), 
        t && fe._data(this, "__className__", t), fe.attr(this, "class", t || !1 === e ? "" :fe._data(this, "__className__") || ""));
      });
    },
    hasClass:function(e) {
      var t, i, n = 0;
      for (t = " " + e + " "; i = this[n++]; ) if (1 === i.nodeType && (" " + q(i) + " ").replace(zt, " ").indexOf(t) > -1) return !0;
      return !1;
    }
  ...
  var Ot = e.location, Ht = fe.now(), Rt = /\?/, Wt = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
  fe.parseJSON = function(t) {
    if (e.JSON && e.JSON.parse) return e.JSON.parse(t + "");
    var i, n = null, s = fe.trim(t + "");
    return s && !fe.trim(s.replace(Wt, function(e, t, s, r) {
      return i && t && (n = 0), 0 === n ? e :(i = s || t, n += !r - !s, "");
    })) ? Function("return " + s)() :fe.error("Invalid JSON: " + t);
  }, fe.parseXML = function(t) {
    var i, n;
    if (!t || "string" != typeof t) return null;
    try {
      e.DOMParser ? (n = new e.DOMParser(), i = n.parseFromString(t, "text/xml")) :(i = new e.ActiveXObject("Microsoft.XMLDOM"), 
  ...
  var $t = /#.*$/, Bt = /([?&])_=[^&]*/, qt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Vt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ut = /^(?:GET|HEAD)$/, Yt = /^\/\//, Xt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Gt = {}, Qt = {}, Zt = "*/".concat("*"), Kt = Ot.href, Jt = Xt.exec(Kt.toLowerCase()) || [];
  fe.extend({
    active:0,
    lastModified:{},
    etag:{},
    ...
    ajax:function(t, i) {
      function n(t, i, n, s) {
        var r, h, y, b, x, C = i;
        2 !== w && (w = 2, l && e.clearTimeout(l), u = undefined, a = s || "", _.readyState = t > 0 ? 4 :0, 
        r = t >= 200 && t < 300 || 304 === t, n && (b = X(d, _, n)), b = G(d, b, _, r), 
        r ? (d.ifModified && (x = _.getResponseHeader("Last-Modified"), x && (fe.lastModified[o] = x), 
        (x = _.getResponseHeader("etag")) && (fe.etag[o] = x)), 204 === t || "HEAD" === d.type ? C = "nocontent" :304 === t ? C = "notmodified" :(C = b.state, 
        h = b.data, y = b.error, r = !y)) :(y = C, !t && C || (C = "error", t < 0 && (t = 0))), 
        _.status = t, _.statusText = (i || C) + "", r ? m.resolveWith(f, [ h, C, _ ]) :m.rejectWith(f, [ _, C, y ]), 
        _.statusCode(v), v = undefined, c && p.trigger(r ? "ajaxSuccess" :"ajaxError", [ _, d, r ? h :y ]), 
        g.fireWith(f, [ _, C ]), c && (p.trigger("ajaxComplete", [ _, d ]), --fe.active || fe.event.trigger("ajaxStop")));
      }
      "object" == typeof t && (i = t, t = undefined), i = i || {};
      var s, r, o, a, l, c, u, h, d = fe.ajaxSetup({}, i), f = d.context || d, p = d.context && (f.nodeType || f.jquery) ? fe(f) :fe.event, m = fe.Deferred(), g = fe.Callbacks("once memory"), v = d.statusCode || {}, y = {}, b = {}, w = 0, x = "canceled", _ = {
        readyState:0,
        getResponseHeader:function(e) {
          var t;
          if (2 === w) {
            if (!h) for (h = {}; t = qt.exec(a); ) h[t[1].toLowerCase()] = t[2];
            t = h[e.toLowerCase()];
          }
      ...
      if (m.promise(_).complete = g.add, _.success = _.done, _.error = _.fail, d.url = ((t || d.url || Kt) + "").replace($t, "").replace(Yt, Jt[1] + "//"), 
      d.type = i.method || i.type || d.method || d.type, d.dataTypes = fe.trim(d.dataType || "*").toLowerCase().match(Ee) || [ "" ], 
      null == d.crossDomain && (s = Xt.exec(d.url.toLowerCase()), d.crossDomain = !(!s || s[1] === Jt[1] && s[2] === Jt[2] && (s[3] || ("http:" === s[1] ? "80" :"443")) === (Jt[3] || ("http:" === Jt[1] ? "80" :"443")))), 
      d.data && d.processData && "string" != typeof d.data && (d.data = fe.param(d.data, d.traditional)), 
      U(Gt, d, i, _), 2 === w) return _;
      c = fe.event && d.global, c && 0 == fe.active++ && fe.event.trigger("ajaxStart"), 
      d.type = d.type.toUpperCase(), d.hasContent = !Ut.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Rt.test(o) ? "&" :"?") + d.data, 
      delete d.data), !1 === d.cache && (d.url = Bt.test(o) ? o.replace(Bt, "$1_=" + Ht++) :o + (Rt.test(o) ? "&" :"?") + "_=" + Ht++)), 
      d.ifModified && (fe.lastModified[o] && _.setRequestHeader("If-Modified-Since", fe.lastModified[o]), 
      fe.etag[o] && _.setRequestHeader("If-None-Match", fe.etag[o])), (d.data && d.hasContent && !1 !== d.contentType || i.contentType) && _.setRequestHeader("Content-Type", d.contentType), 
      ...
      if (d.beforeSend && (!1 === d.beforeSend.call(f, _, d) || 2 === w)) return _.abort();
      x = "abort";
      for (r in {
        success:1,
        error:1,
      ...
      if (u = U(Qt, d, i, _)) {
        if (_.readyState = 1, c && p.trigger("ajaxSend", [ _, d ]), 2 === w) return _;
    ...
    fe[t] = function(e, i, n, s) {
      return fe.isFunction(i) && (s = s || n, n = i, i = undefined), fe.ajax(fe.extend({
        url:e,
        type:t,
        dataType:s,
        data:i,
  ...
  fe.param = function(e, t) {
    ...
    serializeArray:function() {
      return this.map(function() {
        ...
        var e = this.type;
        return this.name && !fe(this).is(":disabled") && si.test(this.nodeName) && !ni.test(e) && (this.checked || !He.test(e));
      }).map(function(e, t) {
        var i = fe(this).val();
  ...
  var ri = 0, oi = {}, ai = fe.ajaxSettings.xhr();
  e.attachEvent && e.attachEvent("onunload", function() {
    for (var e in oi) oi[e](undefined, !0);
  }), he.cors = !!ai && "withCredentials" in ai, ai = he.ajax = !!ai, ai && fe.ajaxTransport(function(t) {
      ...
      return {
        send:function(n, s) {
          ...
          o.send(t.hasContent && t.data || null), i = function(e, n) {
            var r, l, c;
            if (i && (n || 4 === o.readyState)) if (delete oi[a], i = undefined, o.onreadystatechange = fe.noop, 
          ...
          }, t.async ? 4 === o.readyState ? e.setTimeout(i) :o.onreadystatechange = oi[a] = i :i();
        },
        abort:function() {
          i && i(undefined, !0);
        }
    ...
    if (e.crossDomain) {
      ...
      return {
        send:function(n, s) {
          t = ne.createElement("script"), t.async = !0, e.scriptCharset && (t.charset = e.scriptCharset), 
  ...
  fe.ajaxSetup({
    ...
    jsonpCallback:function() {
      var e = li.pop() || fe.expando + "_" + Ht++;
      return this[e] = !0, e;
    }
  }), fe.ajaxPrefilter("json jsonp", function(t, i, n) {
    var s, r, o, a = !1 !== t.jsonp && (ci.test(t.url) ? "url" :"string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && ci.test(t.data) && "data");
    if (a || "jsonp" === t.dataTypes[0]) return s = t.jsonpCallback = fe.isFunction(t.jsonpCallback) ? t.jsonpCallback() :t.jsonpCallback, 
    a ? t[a] = t[a].replace(ci, "$1" + s) :!1 !== t.jsonp && (t.url += (Rt.test(t.url) ? "&" :"?") + t.jsonp + "=" + s), 
    t.converters["script json"] = function() {
      return o || fe.error(s + " was not called"), o[0];
    }, t.dataTypes[0] = "json", r = e[s], e[s] = function() {
      o = arguments;
    }, n.always(function() {
      r === undefined ? fe(e).removeProp(s) :e[s] = r, t[s] && (t.jsonpCallback = i.jsonpCallback, 
      li.push(s)), o && fe.isFunction(r) && r(o[0]), o = r = undefined;
    }), "script";
    ...
    "boolean" == typeof t && (i = t, t = !1), t = t || (he.createHTMLDocument ? ne.implementation.createHTMLDocument("") :ne);
    var n = _e.exec(e), s = !i && [];
    return n ? [ t.createElement(n[1]) ] :(n = v([ e ], t, s), s && s.length && fe(s).remove(), 
  ...
  fe.fn.load = function(e, t, i) {
    ...
    return a > -1 && (n = fe.trim(e.slice(a, e.length)), e = e.slice(0, a)), fe.isFunction(t) ? (i = t, 
    t = undefined) :t && "object" == typeof t && (s = "POST"), o.length > 0 && fe.ajax({
      url:e,
      type:s || "GET",
      dataType:"html",
      data:t
    }).done(function(e) {
      r = arguments, o.html(n ? fe("<div>").append(fe.parseHTML(e)).find(n) :e);
    ...
    setOffset:function(e, t, i) {
      var n, s, r, o, a, l, c, u = fe.css(e, "position"), h = fe(e), d = {};
      "static" === u && (e.style.position = "relative"), a = h.offset(), r = fe.css(e, "top"), 
      l = fe.css(e, "left"), c = ("absolute" === u || "fixed" === u) && fe.inArray("auto", [ r, l ]) > -1, 
      c ? (n = h.position(), o = n.top, s = n.left) :(o = parseFloat(r) || 0, s = parseFloat(l) || 0), 
      fe.isFunction(t) && (t = t.call(e, i, fe.extend({}, a))), null != t.top && (d.top = t.top - a.top + o), 
    ...
    offset:function(e) {
      ...
      if (r) return t = r.documentElement, fe.contains(t, s) ? ("undefined" != typeof s.getBoundingClientRect && (n = s.getBoundingClientRect()), 
      i = te(r), {
    ...
    position:function() {
      if (this[0]) {
        ...
        t = this.offset(), fe.nodeName(e[0], "html") || (i = e.offset()), i.top += fe.css(e[0], "borderTopWidth", !0), 
        i.left += fe.css(e[0], "borderLeftWidth", !0)), {
    ...
    fe.fn[e] = function(n) {
      return Oe(this, function(e, n, s) {
        var r = te(e);
        if (s === undefined) return r ? t in r ? r[t] :r.document.documentElement[n] :e[n];
        r ? r.scrollTo(i ? fe(r).scrollLeft() :s, i ? s :fe(r).scrollTop()) :e[n] = s;
      }, e, n, arguments.length, null);
    };
  }), fe.each([ "top", "left" ], function(e, t) {
    fe.cssHooks[t] = D(he.pixelPosition, function(e, i) {
      if (i) return i = pt(e, t), ut.test(i) ? fe(e).position()[t] + "px" :i;
    });
  }), fe.each({
    Height:"height",
    Width:"width"
    ...
    fe.each({
      ...
      fe.fn[n] = function(n, s) {
        var r = arguments.length && (i || "boolean" != typeof n), o = i || (!0 === n || !0 === s ? "margin" :"border");
        return Oe(this, function(t, i, n) {
          var s;
          return fe.isWindow(t) ? t.document.documentElement["client" + e] :9 === t.nodeType ? (s = t.documentElement, 
          Math.max(t.body["scroll" + e], s["scroll" + e], t.body["offset" + e], s["offset" + e], s["client" + e])) :n === undefined ? fe.css(t, i, o) :fe.style(t, i, n, o);
        }, t, r ? n :undefined, r, null);
      };
    });
  }), fe.fn.extend({
    bind:function(e, t, i) {
  ...
  var hi = e.jQuery, di = e.$;
  return fe.noConflict = function(t) {
    return e.$ === fe && (e.$ = di), t && e.jQuery === fe && (e.jQuery = hi), fe;
  }, t || (e.jQuery = e.$ = fe), fe;
}), function(e, t, i) {
  function n(i) {
    var n = t.console;
  ...
  var C;
  for (C in v) Object.prototype.hasOwnProperty.call(v, C) && (e.find[C] = v[C]);
  ...
  e.swap && e.each([ "height", "width", "reliableMarginRight" ], function(t, i) {
    ...
    n && (e.cssHooks[i].get = function() {
      var e;
      return S = !0, e = n.apply(this, arguments), S = !1, e;
    });
  }), e.swap = function(e, t, i, s) {
    var r, o, a = {};
    S || n("jQuery.swap() is undocumented and deprecated");
  ...
  var M = e.event.add, E = e.event.remove, j = e.event.trigger, A = e.fn.toggle, D = e.fn.live, P = e.fn.die, F = e.fn.load, N = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", I = new RegExp("\\b(?:" + N + ")\\b"), L = /(?:^|\s)hover(\.\S+|)\b/, z = function(t) {
  ...
  e.event.add = function(e, t, i, s, r) {
    e !== document && I.test(t) && n("AJAX events should be attached to document: " + t), 
    M.call(this, e, z(t || ""), i, s, r);
  }, e.event.remove = function(e, t, i, n, s) {
    E.call(this, e, z(t) || "", i, n, s);
    ...
    if (!e.isFunction(t) || !e.isFunction(i)) return A.apply(this, arguments);
    ...
    return n("jQuery.fn.live() is deprecated"), D ? D.apply(this, arguments) :(e(this.context).on(t, this.selector, i, s), 
    this);
  }, e.fn.die = function(t, i) {
    return n("jQuery.fn.die() is deprecated"), P ? P.apply(this, arguments) :(e(this.context).off(t, this.selector || "**", i), 
    this);
  }, e.event.trigger = function(e, t, i, s) {
    return i || I.test(e) || n("Global events are undocumented and deprecated"), j.call(this, e, t, i || document, s);
  }, e.each(N.split("|"), function(t, i) {
    e.event.special[i] = {
      setup:function() {
        var t = this;
  ...
  e.position = {
    ...
    t = e.extend({}, t);
    var r, f, m, g, v, y, b = e(t.of), w = e.position.getWithinInfo(t.within), x = e.position.getScrollInfo(w), _ = (t.collision || "flip").split(" "), C = {};
    ...
    g = y.offset, v = e.extend({}, g), e.each([ "my", "at" ], function() {
      ...
      i = h.exec(n[1]), C[this] = [ e ? e[0] :0, i ? i[0] :0 ], t[this] = [ d.exec(n[0])[0], d.exec(n[1])[0] ];
    }), 1 === _.length && (_[1] = _[0]), "right" === t.at[0] ? v.left += f :"center" === t.at[0] && (v.left += f / 2), 
    "bottom" === t.at[1] ? v.top += m :"center" === t.at[1] && (v.top += m / 2), r = i(C.at, f, m), 
    v.left += r[0], v.top += r[1], this.each(function() {
      var s, c, u = e(this), h = u.outerWidth(), d = u.outerHeight(), p = n(this, "marginLeft"), y = n(this, "marginTop"), S = h + p + n(this, "marginRight") + x.width, T = d + y + n(this, "marginBottom") + x.height, k = e.extend({}, v), M = i(C.my, u.outerWidth(), u.outerHeight());
  ...
  function n(e, t) {
    var i = D.length, n = e.constructor, s = y.isFunction(n) && n.prototype || a, r = "constructor";
    for (y.has(e, r) && !y.contains(t, r) && t.push(r); i--; ) (r = D[i]) in e && e[r] !== s[r] && !y.contains(t, r) && t.push(r);
  }
  ...
  }, S = Math.pow(2, 53) - 1, T = C("length"), k = function(e) {
    var t = T(e);
  ...
  y.keys = function(e) {
    ...
    var n, s, r = {}, o = e;
    if (null == o) return r;
    y.isFunction(t) ? (s = y.allKeys(o), n = b(t, i)) :(s = E(arguments, !1, !1, 1), 
    n = function(e, t, i) {
      return t in i;
    }, o = Object(o));
  ...
  var P = function(e, t, i, n) {
    ...
    if (i.push(e), n.push(t), r) {
      ...
      for (;l--; ) if (c = u[l], !y.has(t, c) || !P(e[c], t[c], i, n)) return !1;
    }
  ...
  y.escape = I(F), y.unescape = I(N), y.result = function(e, t, i) {
  ...
  y.template = function(e, t, i) {
    ...
    var n = RegExp([ (t.escape || z).source, (t.interpolate || z).source, (t.evaluate || z).source ].join("|") + "|$", "g"), s = 0, r = "__p+='";
  ...
  m() && !g() && (S = !1), t.uniform = {
    ...
    var n = this;
    return i = t.extend({}, t.uniform.defaults, i), T || (T = !0, f() && (S = !1)), 
    S ? (i.resetSelector && t(i.resetSelector).mouseup(function() {
  ...
  function a(t) {
    ...
    if (r && r.container) {
      ...
      var a = A[r.id] || [], l = e(a[0] || r.container), u = a[1];
      if (l.length) {
        n && _(i, n.id, h(l));
  ...
  function x(e, t) {
    A[e] = t, P.push(e), C(D, 0), C(P, s.defaults.maxCacheLength);
  }
  function _(e, t, i) {
    var n, r;
    A[t] = i, "forward" === e ? (n = P, r = D) :(n = D, r = P), n.push(t), (t = r.pop()) && delete A[t], 
    C(n, s.defaults.maxCacheLength);
  }
  function C(e, t) {
  ...
  var M = !0, E = window.location.href, j = window.history.state;
  j && j.container && (s.state = j), "state" in window.history && (M = !1);
  var A = {}, D = [], P = [];
  ...
  var i = {
    ...
    function o() {
      k = e(T), "true" != k.attr("data-mentions-input") && (M = k.parent(), j = e(r.templates.wrapper()), 
      k.wrapAll(j), j = M.find("> div.mentions-input-box"), k.attr("data-mentions-input", "true"), 
      k.bind("keydown", b), k.bind("keypress", y), k.bind("input", v), k.bind("click", m), 
      k.bind("blur", g), r.elastic && k.elastic());
    }
    function a() {
      E = e(r.templates.autocompleteList()), E.appendTo(j), E.delegate("li", "mousedown", p);
    }
    function l() {
      A = e(r.templates.mentionsOverlay()), A.prependTo(j);
    }
    function c() {
      var e = f();
      t.each(F, function(t) {
    ...
    function d(e) {
      var t = f(), i = new RegExp("\\" + r.triggerChar + P, "gi");
      if (match = i.exec(t), match) {
        var n = i.lastIndex - P.length - 1, o = i.lastIndex, a = t.substr(0, n), l = t.substr(o, t.length), h = (a + e.value).length;
        r.insertSpaceAfterMention && (h += 1), F.push(e), u(), P = "", w();
        var d = a + e.value;
    ...
    function v() {
      c(), h();
      var e = t.lastIndexOf(I, r.triggerChar);
      e > -1 && (P = I.slice(e + 1).join(""), P = s.rtrim(P), t.defer(t.bind(C, this, P)));
    }
    function y(e) {
    ...
    function b(n) {
      ...
      if (n.keyCode == i.BACKSPACE) return void (I = I.slice(0, -1 + I.length));
      if (!E.is(":visible")) return !0;
      switch (n.keyCode) {
       case i.UP:
       case i.DOWN:
        var s = null;
        return s = n.keyCode == i.DOWN ? D && D.length ? D.next() :E.find("li").first() :e(D).prev(), 
        s.length && x(s), !1;

       case i.RETURN:
       case i.TAB:
        return !D || !D.length || (D.trigger("mousedown"), !1);
      }
      return !0;
    }
    function w() {
    ...
    var T, k, M, E, j, A, D, P, F = [], N = {}, I = [];
    return r = e.extend(!0, {}, n, r), {
      init:function(e) {
        T = e, o(), a(), l(), S(), r.prefillMention && d(r.prefillMention);
      },
      val:function(e) {
        if (t.isFunction(e)) {
  ...
  var n = i.helpers = {}, s = n.each = function(e, t, i) {
    ...
    var o = 0, a = _[i] || _.linear, l = function() {
      o++;
      var i = o / t, c = a(i);
      e.call(r, c, i, o), n.call(r, c, i), o < t ? r.animationFrame = C(l) :s.apply(r);
    };
    C(l);
  ...
  }), D = n.clear = function(e) {
    e.ctx.clearRect(0, 0, e.width, e.height);
  }, P = n.fontString = function(e, t, i) {
    return t + " " + e + "px " + i;
  ...
  }, N = n.drawRoundedRectangle = function(e, t, i, n, s, r) {
  ...
  i.instances = {}, i.Type = function(e, t, n) {
    ...
    resize:function(e) {
      this.stop();
      var t = this.chart.canvas, i = E(this.chart.canvas), n = this.options.maintainAspectRatio ? i / this.chart.aspectRatio :j(this.chart.canvas);
      return t.width = this.chart.width = i, t.height = this.chart.height = n, A(this.chart), 
    ...
    draw:function() {
      ...
      e.font = P(this.fontSize, this.fontStyle, this.fontFamily), this.xAlign = "center", 
      this.yAlign = "above";
      ...
      if (e.fillStyle = this.fillColor, this.custom) this.custom(this); else {
        ...
        N(e, r, o, i, n, this.cornerRadius), e.fill(), e.fillStyle = this.textColor, e.textAlign = "center", 
      ...
      if (this.display) {
        ...
        if (s(this.yLabels, function(t, i) {
          if (i > 0) {
            ...
            if (this.showLabels) {
              if (e.font = P(this.fontSize, this.fontStyle, this.fontFamily), this.showLabelBackdrop) {
          ...
          for (var t = this.valuesCount - 1; t >= 0; t--) {
            ...
            e.font = P(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), 
      ...
      c.raw.series.forEach(function(e, t) {
        ...
        if (0 !== c.normalized.series[o] || !e.ignoreEmptyValues) {
          ...
          if (w.attr({
            ...
            var C = e.labelInterpolationFnc(_, o);
            if (C || 0 === C) {
              var S = t.elem("text", {
                dx:x.x,
                dy:x.y,
                "text-anchor":n(f, x, e.labelDirection)
              }, e.classNames.label).text("" + C);
              this.eventEmitter.emit("draw", {
                type:"label",
                index:o,
                group:t,
...
!function(e, t) {
  ...
  e.tags = {
    ...
    function c(e, t) {
      var n = "=" + C, s = e.indexOf(n, t), r = i(e.substring(e.indexOf("=", t) + 1, s)).split(" ");
      return _ = r[0], C = r[r.length - 1], s + n.length - 1;
    }
    var u = s.length, h = 0, d = 1, f = h, m = null, g = null, v = "", y = [], b = !1, w = 0, x = 0, _ = "{{", C = "}}";
    for (r && (r = r.split(" "), _ = r[0], C = r[1]), w = 0; w < u; w++) f == h ? n(_, s, w) ? (--w, 
    o(), f = d) :"\n" == s.charAt(w) ? l(b) :v += s.charAt(w) :f == d ? (w += _.length - 1, 
    g = e.tags[s.charAt(w + 1)], m = g ? s.charAt(w + 1) :"_v", "=" == m ? (w = c(s, w), 
    f = h) :(g && w++, f = 2), b = w) :n(C, s, w) ? (y.push({
      tag:m,
      n:i(v),
      otag:_,
      ctag:C,
      i:"/" == m ? b - _.length :w + C.length
    }), v = "", w += C.length - 1, f = h, "{" == m && ("}}" == C ? w++ :t(y[y.length - 1]))) :v += s.charAt(w);
    return l(b, !0), y;
  };
  var b = {
    _t:!0,
      ...
      "function" == typeof $f) {
        ...
        C.addEvent("ready", function() {
          ...
          C.playVideo = function() {
            ...
            e ? (C.lastVolume = C.api("getVolume"), C.api("setVolume", 0)) :(C.api("setVolume", C.lastVolume), 
            delete C.lastVolume);
          }, C.getPlayerState = function() {
            return S;
          }, C.addEvent("play", function() {
            S = 1, e(C, f, "play"), e(C, f, "playing");
            ...
            S = 3, e(C, f, "progress", t);
          }), f.pluginElement = p, f.pluginApi = C, f.success(f, f.pluginElement);
        });
...
Zepto.fn.outerWidth = function(e) {
  ...
  var t = e.tablesorter = {
    ...
    buildCache:function(i, n, s) {
      var r, o, a, l, c, u, h, d, f, p, m, g, v, y, b, w, x, _, C, S, T, k, M = i.table, E = i.parsers;
      if (i.$tbodies = i.$table.children("tbody:not(." + i.cssInfoBlock + ")"), h = void 0 === s ? i.$tbodies :s, 
      i.cache = {}, i.totalRows = 0, !E) return i.debug ? console.warn("Warning: *Empty table!* Not building a cache") :"";
      for (i.debug && (g = new Date()), i.showProcessing && t.isProcessing(M, !0), u = 0; u < h.length; u++) {
        ...
        p = d.children("th, td"), T = b.child.length, b.child[T] = [], _ = 0, S = i.columns, 
        c = 0; c < S; c++) m = p[c], m && (b.child[T][c] = t.getParsedText(i, m, c), (x = p[c].colSpan - 1) > 0 && (_ += x, 
        S += x)), _++; else {
          for (y.$row = d, y.order = l, _ = 0, S = i.columns, c = 0; c < S; ++c) {
            if ((m = d[0].cells[c]) && _ < i.columns && (C = "undefined" != typeof E[_], !C && i.debug && console.warn("No parser found for row: " + l + ", column: " + c + '; cell containing: "' + e(m).text() + '"; does it have a header?'), 
            o = t.getElementText(i, m, _), y.raw[_] = o, a = t.getParsedText(i, m, _, o), f[_] = a, 
            C && "numeric" === (E[_].type || "").toLowerCase() && (w[_] = Math.max(Math.abs(a) || 0, w[_] || 0)), 
            (x = m.colSpan - 1) > 0)) {
  ...
  return function(e, t, i) {
    ...
    t.themes = {
      ...
      format:function(i, n, s) {
        var r, o, a, l, c, u, h, d, f, p, m, g, v, y = t.themes, b = n.$table.add(e(n.namespace + "_extra_table")), w = n.$headers.add(e(n.namespace + "_extra_headers")), x = n.theme || "jui", _ = y[x] || {}, C = e.trim([ _.sortNone, _.sortDesc, _.sortAsc, _.active ].join(" ")), S = e.trim([ _.iconSortNone, _.iconSortDesc, _.iconSortAsc ].join(" "));
        ...
        f.length && (u.removeClass(C), h.removeClass(S), f[0].sortDisabled ? h.removeClass(_.icons || "") :(a = _.sortNone, 
    ...
    e.extend(s, {
      ...
      findRows:function(s, r, o) {
        if (s.config.lastCombinedFilter !== o && s.config.widgetOptions.filter_initialized) {
          var a, l, c, u, h, d, f, p, m, g, v, y, b, w, x, _, C, S, T, k, M, E, j, A = e.extend([], r), D = s.config, P = D.widgetOptions, F = {
            anyMatch:!1,
            filters:r,
            filter_regexCache:[]
          }, N = {
            ...
            excludeFilter:[],
            defaultColFilter:[],
            defaultAnyFilter:n.getColumnData(s, P.filter_defaultFilter, D.columns, !0) || ""
          };
          for (F.parsed = [], m = 0; m < D.columns; m++) F.parsed[m] = P.filter_useParsedData || D.parsers && D.parsers[m] && D.parsers[m].parsed || n.getData && "parsed" === n.getData(D.$headerIndexed[m], n.getColumnData(s, D.headers, m), "filter") || D.$headerIndexed[m].hasClass("filter-parsed"), 
          N.functions[m] = n.getColumnData(s, P.filter_functions, m) || D.$headerIndexed[m].hasClass("filter-select"), 
          N.defaultColFilter[m] = n.getColumnData(s, P.filter_defaultFilter, m) || "", N.excludeFilter[m] = (n.getColumnData(s, P.filter_excludeFilter, m, !0) || "").split(/\s+/);
          for (D.debug && (console.log("Filter: Starting filter widget search", r), w = new Date()), 
          D.filteredRows = 0, D.totalRows = 0, o = (A || []).join(""), f = 0; f < D.$tbodies.length; f++) {
            if (p = n.processTbody(s, D.$tbodies.eq(f), !0), m = D.columns, l = D.cache[f].normalized, 
            u = e(e.map(l, function(e) {
              return e[m].$row.get();
            })), "" === o || P.filter_serversideFiltering) u.removeClass(P.filter_filteredRow).not("." + D.cssChildRow).css("display", ""); else {
              if (u = u.not("." + D.cssChildRow), a = u.length, (P.filter_$anyMatch && P.filter_$anyMatch.length || "undefined" != typeof r[D.columns]) && (F.anyMatchFlag = !0, 
              F.anyMatchFilter = "" + (r[D.columns] || P.filter_$anyMatch && t.getLatestSearch(P.filter_$anyMatch).val() || ""), 
              P.filter_columnAnyMatch)) {
                for (T = F.anyMatchFilter.split(i.andSplit), k = !1, _ = 0; _ < T.length; _++) M = T[_].split(":"), 
                M.length > 1 && (isNaN(M[0]) ? e.each(D.headerContent, function(e, t) {
                  t.toLowerCase().indexOf(M[0]) > -1 && (E = e, r[E] = M[1]);
                }) :E = parseInt(M[0], 10) - 1, E >= 0 && E < D.columns && (r[E] = M[1], T.splice(_, 1), 
                _--, k = !0));
                k && (F.anyMatchFilter = T.join(" && "));
              }
              if (S = P.filter_searchFiltered, v = D.lastSearch || D.$table.data("lastSearch") || [], 
              S) for (_ = 0; _ < m + 1; _++) x = r[_] || "", S || (_ = m), S = S && v.length && 0 === x.indexOf(v[_] || "") && !i.alreadyFiltered.test(x) && !i.exactTest.test(x) && !(i.isNeg1.test(x) || i.isNeg2.test(x)) && !("" !== x && D.$filters && D.$filters.filter('[data-column="' + _ + '"]').find("select").length && !t.matchType(D, _));
              for (C = u.not("." + P.filter_filteredRow).length, S && 0 === C && (S = !1), D.debug && console.log("Filter: Searching through " + (S && C < a ? C :"all") + " rows"), 
              F.anyMatchFlag && (D.sortLocaleCompare && (F.anyMatchFilter = n.replaceAccents(F.anyMatchFilter)), 
              P.filter_defaultFilter && i.iQuery.test(N.defaultAnyFilter) && (F.anyMatchFilter = t.defaultFilter(F.anyMatchFilter, N.defaultAnyFilter), 
              S = !1), F.iAnyMatchFilter = P.filter_ignoreCase && D.ignoreCase ? F.anyMatchFilter.toLowerCase() :F.anyMatchFilter), 
              d = 0; d < a; d++) if (j = u[d].className, !(d && i.child.test(j) || S && i.filtered.test(j))) {
                if (F.$row = u.eq(d), F.rowIndex = d, F.cacheArray = l[d], c = F.cacheArray[D.columns], 
                F.rawArray = c.raw, F.childRowText = "", !P.filter_childByColumn) {
                  for (j = "", g = c.child, _ = 0; _ < g.length; _++) j += " " + g[_].join(" ") || "";
                  F.childRowText = P.filter_childRows ? P.filter_ignoreCase ? j.toLowerCase() :j :"";
                }
                if (y = !1, b = t.processRow(D, F, N), h = c.$row, x = !!b, g = c.$row.filter(":gt(0)"), 
                P.filter_childRows && g.length) {
                  if (P.filter_childByColumn) for (P.filter_childWithSibs || (g.addClass(P.filter_filteredRow), 
                  h = h.eq(0)), _ = 0; _ < g.length; _++) F.$row = g.eq(_), F.cacheArray = c.child[_], 
                  F.rawArray = F.cacheArray, x = t.processRow(D, F, N), y = y || x, !P.filter_childWithSibs && x && g.eq(_).removeClass(P.filter_filteredRow);
                  y = y || b;
                } else y = x;
                h.toggleClass(P.filter_filteredRow, !y)[0].display = y ? "" :"none";
              }
            }
            D.filteredRows += u.not("." + P.filter_filteredRow).length, D.totalRows += u.length, 
            n.processTbody(s, p, !1);
          }
          D.lastCombinedFilter = o, D.lastSearch = A, D.$table.data("lastSearch", A), P.filter_saveFilters && n.storage && n.storage(s, "tablesorter-filters", t.processFilters(A, !0)), 
          D.debug && console.log("Completed filter widget search" + n.benchmark(w)), P.filter_initialized && (D.$table.triggerHandler("filterBeforeEnd", D), 
          D.$table.triggerHandler("filterEnd", D)), setTimeout(function() {
            n.applyWidget(D.table);
          }, 0);
        }
      },
    ...
    e.extend(i.css, {
      ...
      format:function(n, s, r) {
        if (!(s.$table.hasClass("hasStickyHeaders") || e.inArray("filter", s.widgets) >= 0 && !s.$table.hasClass("hasFilters"))) {
          var o, a, l, c, u = s.$table, h = e(r.stickyHeaders_attachTo), d = s.namespace + "stickyheaders ", f = e(r.stickyHeaders_yScroll || r.stickyHeaders_attachTo || t), p = e(r.stickyHeaders_xScroll || r.stickyHeaders_attachTo || t), m = u.children("thead:first"), g = m.children("tr").not(".sticky-false").children(), v = u.children("tfoot"), y = isNaN(r.stickyHeaders_offset) ? e(r.stickyHeaders_offset) :"", b = y.length ? y.height() || 0 :parseInt(r.stickyHeaders_offset, 10) || 0, w = u.parent().closest("." + i.css.table).hasClass("hasStickyHeaders") ? u.parent().closest("table.tablesorter")[0].config.widgetOptions.$sticky.parent() :[], x = w.length ? w.height() :0, _ = r.$sticky = u.clone().addClass("containsStickyHeaders " + i.css.sticky + " " + r.stickyHeaders + " " + s.namespace.slice(1) + "_extra_table").wrap('<div class="' + i.css.stickyWrap + '">'), C = _.parent().addClass(i.css.stickyHide).css({
          ...
          }), S = _.children("thead:first"), T = "", k = 0, M = function(e, i) {
            ...
            if (u.is(":visible")) {
              ...
              var n = u.offset(), s = e.isWindow(f[0]), o = e.isWindow(p[0]), a = h.length ? s ? f.scrollTop() :f.offset().top :f.scrollTop(), l = r.stickyHeaders_includeCaption ? 0 :u.children("caption").height() || 0, c = a + b + x - l, d = u.height() - (C.height() + (v.height() || 0)) - l, m = c > n.top && c < n.top + d ? "visible" :"hidden", g = {
                visibility:m
              };
              h.length && (g.top = s ? c - h.offset().top :h.scrollTop()), o && (g.left = u.offset().left - parseInt(u.css("margin-left"), 10) - p.scrollLeft() - k), 
              w.length && (g.top = (g.top || 0) + b + x), C.removeClass(i.css.stickyVis + " " + i.css.stickyHide).addClass("visible" === m ? i.css.stickyVis :i.css.stickyHide).css(g), 
              (m !== T || t) && (E(), T = m);
            }
          };
          ...
          _.find("caption").toggle(r.stickyHeaders_includeCaption), c = S.children().children(), 
          _.css({
            height:0,
            width:0,
            margin:0
            ...
            E();
          }), i.bindEvents(n, S.children().children("." + i.css.header)), r.stickyHeaders_appendTo ? e(r.stickyHeaders_appendTo).append(C) :u.after(C), 
          s.onRenderHeader) for (l = S.children("tr").children(), a = l.length, o = 0; o < a; o++) s.onRenderHeader.apply(l.eq(o), [ o, s, _ ]);
          p.add(f).unbind("scroll resize ".split(" ").join(d).replace(/\s+/g, " ")).bind("scroll resize ".split(" ").join(d), function(e) {
            ...
            C.hasClass(i.css.stickyVis) && r.stickyHeaders_filteredToTop && (t.scrollTo(0, u.position().top), 
...
//# sourceMappingURL=/assets/maps/application_vendor-c6c13f29009d8753b19cae70e277c02aa852bcdc46dbae85351d077e49b15ac0.js.map
